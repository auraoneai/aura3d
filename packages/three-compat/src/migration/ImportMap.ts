export const THREE_COMPAT_THREE_IMPORT_MAP: Readonly<Record<string, string>> = {
  ...
  "three/addons/postprocessing/EffectComposer.js": "@aura3d/three-compat/postprocessing",
  "three/examples/jsm/postprocessing/EffectComposer.js": "@aura3d/three-compat/postprocessing"
};
