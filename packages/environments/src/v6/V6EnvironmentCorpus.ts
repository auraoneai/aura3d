...
export interface V6EnvironmentManifest {
  readonly schema: "g3d-v6-hdr-environment-corpus/v1";
...
export interface V6EnvironmentCorpusSummary {
  readonly schema: "g3d-v6-environment-readiness/v1";
...
export function loadV6EnvironmentManifest(path = "fixtures/v6/environments/manifest.json"): V6EnvironmentManifest {
...
export function createV6EnvironmentCorpusSummary(manifest = loadV6EnvironmentManifest()): V6EnvironmentCorpusSummary {
  ...
  return {
    schema: "g3d-v6-environment-readiness/v1",
