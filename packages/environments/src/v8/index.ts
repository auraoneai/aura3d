...
export const V8_ENVIRONMENTS: readonly V8EnvironmentPreset[] = [
  {
    ...
    localPath: "fixtures/v6/environments/hdri/studio_small_08_1k.hdr",
    class: "studio",
    intensity: 1.15,
  ...
  },
  {
    id: "venice-sunset",
    label: "Venice Sunset",
    localPath: "fixtures/v6/environments/hdri/venice_sunset_1k.hdr",
    class: "outdoor",
    intensity: 1.35,
  ...
  },
  {
    ...
    localPath: "fixtures/v6/environments/hdri/industrial_sunset_puresky_1k.hdr",
    class: "industrial",
    intensity: 1.28,
