...
export interface LeanWebGL2DeviceOptions {
  readonly canvas: HTMLCanvasElement | OffscreenCanvas;
  readonly antialias?: boolean;
  readonly alpha?: boolean;
  readonly preserveDrawingBuffer?: boolean;
  readonly errorCheckMode?: LeanWebGL2ErrorCheckMode;
}

export type LeanWebGL2ErrorCheckMode = "strict" | "frame";
...
export class LeanWebGL2Device implements RenderDevice {
  ...
  static create(options: LeanWebGL2DeviceOptions): LeanWebGL2Device {
    ...
    // `strict` explicitly.
    return new LeanWebGL2Device(gl as WebGL2RenderingContext, options.canvas, options.errorCheckMode ?? "frame");
  }

  private constructor(
    gl: WebGL2RenderingContext,
    canvas: HTMLCanvasElement | OffscreenCanvas,
    private readonly errorCheckMode: LeanWebGL2ErrorCheckMode
  ) {
    this.gl = gl;
