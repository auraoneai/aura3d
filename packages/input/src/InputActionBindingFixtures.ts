...
/**
 * @deprecated Retained for v1.x compatibility. Prefer `ActionMap` bindings for
 * runtime input; this helper only applies a deterministic processor sequence.
 */
...
/**
 * @deprecated Retained so the published v1.5 API remains import-compatible.
 * This deterministic sample is diagnostic evidence, not a runtime parity claim.
 */
