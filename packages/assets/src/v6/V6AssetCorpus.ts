...
export interface V6AssetManifest {
  readonly schema: "g3d-v6-real-asset-corpus/v1";
...
export interface V6AssetCorpusSummary {
  readonly schema: "g3d-v6-asset-readiness/v1";
...
export function loadV6AssetManifest(path = "fixtures/v6/assets/manifest.json"): V6AssetManifest {
...
export function createV6AssetCorpusSummary(manifest = loadV6AssetManifest()): V6AssetCorpusSummary {
  ...
  return {
    schema: "g3d-v6-asset-readiness/v1",
