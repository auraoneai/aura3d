...
import { episodeBuilderSupport, installEpisodeBuilderPanel } from "./builder";
...
captionOverlay.textContent = firstCaption?.text ?? firstStoryboardShot?.storyBeat ?? "Aura3D episode builder";
...
const app = createAuraApp("#app", {
  scene: scene()
    ...
    .add(labels.hud(firstCaption?.text ?? firstStoryboardShot?.storyBeat ?? "Aura3D episode builder"))
