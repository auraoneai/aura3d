import type { AnimationGesture } from "./AnimationPerformance.js";

export const bodyLanguageLibrary: readonly AnimationGesture[] = [
...
export function resolveBodyLanguageGesture(id: string): AnimationGesture | undefined {
