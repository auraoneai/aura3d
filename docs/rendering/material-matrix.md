...
The renderer does not claim exact shader equivalence for every manual renderer code material or every glTF extension. Claims must name the material feature, route/test evidence, and current limitations.
