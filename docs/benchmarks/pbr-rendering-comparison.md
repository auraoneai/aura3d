...
- G3D has bounded PBR and material-rendering evidence against same-page or actual Three.js references.
- G3D can render selected PBR/product/material comparison scenes with retained screenshots and metrics.
