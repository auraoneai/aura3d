...
| Scene | Equivalent scaffold | Galileo browser frame median ms | Three.js browser frame median ms | Galileo executed/requested draw calls | Galileo bundle bytes | Galileo scene source bytes |
|---|---:|---:|---:|---:|---:|---:|
...
Measured dimension: esbuild browser benchmark bundle bytes. Evidence report: `tests/reports/comparison-threejs.json`.

| Scene | Galileo bundle bytes | Three.js bundle bytes | Galileo / Three.js ratio |
|---|---:|---:|---:|
| product-configurator | 246654 | 671336 | 0.367 |
| large-scene | 246650 | 671332 | 0.367 |
| skinned-characters | 246669 | 671351 | 0.367 |
...
| Area | Galileo3D evidence | Three.js evidence | Current comparison evidence | Claim impact |
|---|---|---|---|---|
