...
| V6 rendered parity suite | `tests/reports/v6-threejs-parity-readiness.json`, `tests/reports/v6-threejs-runtime-parity.json`, `tests/reports/v6-threejs-visual-parity.json`, `tests/reports/v6-threejs-parity/**` | Passes bounded product/material/asset/architecture scene checks with retained G3D, Three.js, and diff screenshots. |
