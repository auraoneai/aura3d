...
- [x] Make `verify:trace` reject rows that cite `docs/project/rebuild-progress.md passed` without source and test files.
...
- [x] `docs/project/completion-audit.md`, `docs/project/implementation-plan.md`, and `docs/project/v2-decision-gates.md` agree on status.
...
- `docs/project/v2-validation-and-benchmark-plan.md`
...
- [x] Add public claim guidelines that bind docs, README, release notes, and marketing copy to `docs/project/v2-claim-registry.md`.
