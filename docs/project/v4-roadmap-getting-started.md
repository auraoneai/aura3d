...
V4 is the local release track for the installable `@aura3d/engine` SDK, the `create-aura3d` scaffolder, and the supported V4 app workflows.
...
- `tests/reports/v4-create-aura3d-templates.json`
