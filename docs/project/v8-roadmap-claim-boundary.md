...
A3D can claim a capability only when the relevant route, test, and report pass.

Allowed examples:

- "This route loads and renders a named GLB with A3D WebGL2."
...
- A3D fully replaces Three.js.
- A3D fully exceeds Three.js.
- A3D supports every Three.js example.
- A3D supports every GLTF extension.
- A3D has full WebGPU parity.
- A3D is faster than Three.js generally.
...
- source-boundary scan proving A3D runtime packages do not import `three`
...
- outputs from Three.js mislabeled as A3D
