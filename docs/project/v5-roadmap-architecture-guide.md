...
The architecture workflow proves that G3D V5 can handle composed scenes with scale, lighting variation, materials, controls, and screenshot evidence. It is not enough to render an isolated cube or a single imported chair.
