...
A3D Visual Engine V4 is an installable browser 3D SDK/runtime/toolchain for developers building production-shaped web 3D applications in supported workflows.

The primary artifact is `@aura3d/engine`.
...
A3D Visual Engine V4 is being built as a high-quality Three.js competitor for:
...
- `createA3DApp` creates a browser runtime with quality presets and diagnostics.
...
- `create-aura3d` and Vite templates prove a fresh external project can build from a packed package.
