...
|---|---|---|---|
| Galileo3D is an production TypeScript-first browser 3D engine and workflow SDK. | None | V10 package, route, benchmark, and claim-defense evidence. | Must link current claims to V10 evidence. |
...
|---|---|---|
| Galileo3D matches or exceeds Three.js in measured categories. | Gate C | Narrow niche, raw benchmark data, known limits, Three.js/Babylon.js comparison reports, `docs/comparisons/threejs.md`, `docs/comparisons/babylonjs.md`, `tests/reports/comparison-threejs.json`, `tests/reports/comparison-babylon.json`. |
