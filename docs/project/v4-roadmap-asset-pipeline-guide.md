...
The V4 asset pipeline supports bounded glTF/GLB loading, corpus validation, compatibility diagnostics, and app-level troubleshooting. Developers should use `loadAsset`, `inspectAsset`, `createAssetDiagnostics`, `createRenderDiagnostics`, and `createCompatibilityReport` from `@aura3d/engine`.
