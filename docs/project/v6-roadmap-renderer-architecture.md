...
A3D V6 is a proof-backed WebGL2 renderer path for imported glTF assets, HDR environments, PBR materials, runtime diagnostics, examples, templates, and external package consumption.
