...
- [x] `packages/three-compat/src/migration/ThreeToA3DAdapter.ts`
...
- [x] `benchmarks/three-compat/aura3d/`
...
- [x] `packages/create-aura3d/templates/three-compat-premium-product-viewer/`
- [x] `packages/create-aura3d/templates/three-compat-architecture-interior/`
- [x] `packages/create-aura3d/templates/three-compat-material-authoring/`
- [x] `packages/create-aura3d/templates/three-compat-asset-inspector/`
- [x] `packages/create-aura3d/templates/three-compat-character-viewer/`
- [x] `packages/create-aura3d/templates/three-compat-postprocess-scene/`
- [x] `packages/create-aura3d/templates/three-compat-custom-threejs-migration/`
- [x] `packages/create-aura3d/templates/three-compat-large-scene/`
- [x] `tests/integration/three-compat-create-aura3d.test.ts`
