...
```ts
import { EffectComposerCompat, RenderPassCompat, UnrealBloomPassCompat, SSAOPassCompat, FXAAPassCompat } from "@aura3d/three-compat";
...
Native V5 rendering exposes the same chain through `@aura3d/rendering`.
