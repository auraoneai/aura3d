# Aura3D Recovery Remediation PRD
...
- Turbo Drift Circuit and Skyline Runner are prototype-blocked while the visual
  rebuild and current hash-bound independent review are pending. Their bounded
  typed-asset, geometry, and mounted-gameplay evidence remains technical proof.
...
- [ ] Update `docs/project/architecture/create-aura-app-production-bridge.md`,
...
| `docs/api/contracts/public-api-contract.md` | P1 | Define stable, experimental, and internal exports. Add root `@aura3d/engine` acceptance tests as contract proof. |
...
| File | Priority | Required fix |
| --- | --- | --- |
| `docs/project/status/current-state.md` | P0 | Remove contradictory shipped/planned language. Add honest capability status and known blockers. |
...
| `docs/project/release/release-checklist.md` | P0 | Add asset validation, screenshot checks, route-health, claim boundary, and game input tests. |
...
| `docs/project/status/known-limits.md` | P0 | Keep as canonical limitations doc and link it from all guides. |
| `docs/project/status/product-boundaries.md` | P0 | Preserve and strengthen boundaries for public claims. |
...
| `docs/project/showcase/apps-classification.md` | P1 | Reclassify examples as library demo, prototype, playable game, or marketing-ready. |
...
| `docs/project/roadmaps/library-gap-roadmap.md` | P0 | Durable successor to the library section of this PRD. |
...
- [x] Write `docs/project/roadmaps/library-gap-roadmap.md`.
...
- [x] Update `docs/project/showcase/apps-classification.md`.
