# Aura3D Engine and Game Parity Execution Plan
...
- `docs/project/audits/engine-parity-gap-audit.md` — the Phase 1 deliverable. Measured baseline,
  nine ranked gaps, file:line evidence, fix cost, blocking analysis, and the three recorded
  owner decisions in full.
- `docs/agents/claims-and-boundaries.md` and `docs/project/status/known-limits.md` — binding claim
...
- [x] `docs/project/status/known-limits.md` — declared authority; narrower wording always wins
...
- [x] `AGENTS.md`, `packages/AGENTS.md`, `packages/rendering/AGENTS.md`, `apps/AGENTS.md`,
      `docs/AGENTS.md`
- [x] `docs/project/audits/engine-parity-gap-audit.md` — the gap evidence this file acts on
...
Per `docs/project/status/known-limits.md` these helpers "are not production game-generation APIs or automatic
...
Deliverable `docs/project/audits/engine-parity-gap-audit.md` exists at `c4e1b662`, decisions added
at `601275c4`.
...
- [x] **4.1** Claims and boundaries first, these gate everything else:
      `docs/agents/claims-and-boundaries.md`, `docs/project/status/known-limits.md`,
      `docs/project/claim-guidelines.md`, `docs/project/status/product-boundaries.md`,
      ...
      `.cursor/rules/aura3d.mdc`, `AGENTS.md`, `docs/project/plans/recovery-remediation-prd.md`
...
- [x] **4.2** Rendering / API: `docs/rendering/postprocess.md`, `environment-lighting.md`,
      ...
      `docs/api/contracts/public-api-contract.md`
...
- [x] **4.3** Status / release: `docs/project/status/current-state.md` — it fixes 7/7 public
      ...
      `GoLiveCheckList.md`, `docs/project/release/release-checklist.md`,
...
- [x] **4.4** Per-game: root `README.md`, each `apps/*/README.md`,
      `docs/project/showcase/aura-clash-showcase-plan.md`, `docs/agents/game-showcase-build.md`,
...
1. `docs/project/audits/engine-parity-gap-audit.md` — **done**
