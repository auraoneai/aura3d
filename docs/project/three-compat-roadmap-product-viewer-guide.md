...
The product viewer is the clearest proof point for A3D V5. It must behave like a developer could ship it as a premium commerce, configurator, or technical product page, not like a rendering smoke test.
...
```ts
import { RendererV5 } from "@aura3d/engine/rendering";
import { V5AssetRegistry } from "@aura3d/engine/assets";
import { PBRMaterialLibrary } from "@aura3d/engine/materials";
import { EnvironmentRegistry } from "@aura3d/engine/environments";
import { OrbitControlsCompat } from "@aura3d/engine/controls";
```
...
- `tests/reports/three-compat-threejs-visual-parity/product-configurator-a3d.png`
