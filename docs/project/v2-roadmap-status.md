...
The product target is `A3D Product Studio V1`: a local ecommerce/catalog product-rendering studio backed by generated glTF product assets, a public `@aura3d/product-studio` package, and a usable browser app in `apps/product-studio`.
...
- Product fixtures: `fixtures/product-studio/products/{camera-kit,speaker,watch}`
