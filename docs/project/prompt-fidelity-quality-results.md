...
Generated: 2026-05-28T23:30:51.657Z
...
| `codex-context-self-test` | `agent-context` | `cinematic-scene` | `assets.agentProduct` | `webgl2` | yes | `partial` | no | The app compiles, runs, and uses typed assets. | Rerun after visual recipes and prompt-fidelity repair guidance exist. |
