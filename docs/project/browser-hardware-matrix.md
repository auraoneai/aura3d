...
This matrix records the browser and hardware evidence currently present in this repository. It is a release-gate evidence index, a V10 compatibility evidence index.
...
- Reference this page, `docs/project/compatibility.md`, and `docs/project/v2-claim-registry.md` before publishing compatibility wording.
