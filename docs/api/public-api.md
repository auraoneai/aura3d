...
|---|---:|---|---:|
| `@aura3d/animation` | `2.0.0` | `packages/animation/src/index.ts` | 45 |
| `@aura3d/apps` | `2.0.0` | `packages/apps/src/index.ts` | 10 |
| `@aura3d/asset-index` | `2.0.0` | `packages/asset-index/src/index.ts` | 32 |
| `@aura3d/assets` | `2.0.0` | `packages/assets/src/index.ts` | 78 |
| `@aura3d/assets/gltf-runtime` | `2.0.0` | `packages/assets/src/gltf-runtime.ts` | 4 |
| `@aura3d/audio` | `2.0.0` | `packages/audio/src/index.ts` | 25 |
| `@aura3d/cli` | `2.0.0` | `packages/aura3d-cli/src/index.ts` | 32 |
| `@aura3d/controls` | `2.0.0` | `packages/controls/src/index.ts` | 25 |
| `@aura3d/core` | `2.0.0` | `packages/core/src/index.ts` | 14 |
| `create-aura3d` | `2.0.0` | `packages/create-aura3d/src/index.ts` | 10 |
| `@aura3d/debug` | `2.0.0` | `packages/debug/src/index.ts` | 30 |
| `@aura3d/ecs` | `2.0.0` | `packages/ecs/src/index.ts` | 25 |
| `@aura3d/editor` | `2.0.0` | `packages/editor/src/index.ts` | 1 |
| `@aura3d/editor-runtime` | `2.0.0` | `packages/editor-runtime/src/index.ts` | 80 |
| `@aura3d/engine` | `2.0.0` | `packages/engine/src/index.ts` | 39 |
...
| `@aura3d/navigation-recast` | `2.0.0` | `packages/navigation-recast/src/index.ts` | 15 |
| `@aura3d/physics` | `2.0.0` | `packages/physics/src/index.ts` | 22 |
| `@aura3d/physics-rapier` | `2.0.0` | `packages/physics-rapier/src/index.ts` | 18 |
| `@aura3d/physics/solverless` | `2.0.0` | `packages/physics/src/solverless.ts` | 13 |
| `@aura3d/physics/world` | `2.0.0` | `packages/physics/src/world.ts` | 2 |
| `@aura3d/product-studio` | `2.0.0` | `packages/product-studio/src/index.ts` | 12 |
| `@aura3d/react` | `2.0.0` | `packages/react/src/index.ts` | 14 |
| `@aura3d/rendering` | `2.0.0` | `packages/rendering/src/index.ts` | 266 |
| `@aura3d/rendering/lean-runtime` | `2.0.0` | `packages/rendering/src/lean-runtime.ts` | 10 |
| `@aura3d/rendering/webgpu` | `2.0.0` | `packages/rendering/src/webgpu.ts` | 2 |
| `@aura3d/scene` | `2.0.0` | `packages/scene/src/index.ts` | 21 |
| `@aura3d/scripting` | `2.0.0` | `packages/scripting/src/index.ts` | 37 |
| `@aura3d/three-compat` | `2.0.0` | `packages/three-compat/src/index.ts` | 29 |
| `@aura3d/workflows` | `2.0.0` | `packages/workflows/src/index.ts` | 12 |
