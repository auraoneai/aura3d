...
|---|---:|---|---:|
| `@aura3d/animation` | `2.0.1` | `packages/animation/src/index.ts` | 45 |
| `@aura3d/apps` | `2.0.1` | `packages/apps/src/index.ts` | 10 |
| `@aura3d/asset-index` | `2.0.1` | `packages/asset-index/src/index.ts` | 32 |
| `@aura3d/assets` | `2.0.1` | `packages/assets/src/index.ts` | 78 |
| `@aura3d/assets/gltf-runtime` | `2.0.1` | `packages/assets/src/gltf-runtime.ts` | 4 |
| `@aura3d/audio` | `2.0.1` | `packages/audio/src/index.ts` | 25 |
| `@aura3d/cli` | `2.0.1` | `packages/aura3d-cli/src/index.ts` | 32 |
| `@aura3d/controls` | `2.0.1` | `packages/controls/src/index.ts` | 25 |
| `@aura3d/core` | `2.0.1` | `packages/core/src/index.ts` | 14 |
| `create-aura3d` | `2.0.1` | `packages/create-aura3d/src/index.ts` | 10 |
| `@aura3d/debug` | `2.0.1` | `packages/debug/src/index.ts` | 30 |
| `@aura3d/ecs` | `2.0.1` | `packages/ecs/src/index.ts` | 25 |
| `@aura3d/editor` | `2.0.1` | `packages/editor/src/index.ts` | 1 |
| `@aura3d/editor-runtime` | `2.0.1` | `packages/editor-runtime/src/index.ts` | 80 |
| `@aura3d/engine` | `2.0.1` | `packages/engine/src/index.ts` | 39 |
| `@aura3d/environments` | `2.0.1` | `packages/environments/src/index.ts` | 5 |
| `@aura3d/environments/node` | `2.0.1` | `packages/environments/src/node.ts` | 6 |
| `@aura3d/input` | `2.0.1` | `packages/input/src/index.ts` | 42 |
| `@aura3d/lean` | `2.0.1` | `packages/lean/src/index.ts` | 2 |
| `@aura3d/lean/game` | `2.0.1` | `packages/lean/src/game.ts` | 5 |
| `@aura3d/lean/product` | `2.0.1` | `packages/lean/src/product.ts` | 2 |
| `@aura3d/materials` | `2.0.1` | `packages/materials/src/index.ts` | 1 |
| `@aura3d/materials/node` | `2.0.1` | `packages/materials/src/node.ts` | 3 |
| `@aura3d/math` | `2.0.1` | `packages/math/src/index.ts` | 18 |
| `@aura3d/navigation-recast` | `2.0.1` | `packages/navigation-recast/src/index.ts` | 15 |
| `@aura3d/physics` | `2.0.1` | `packages/physics/src/index.ts` | 22 |
| `@aura3d/physics-rapier` | `2.0.1` | `packages/physics-rapier/src/index.ts` | 18 |
| `@aura3d/physics/solverless` | `2.0.1` | `packages/physics/src/solverless.ts` | 13 |
| `@aura3d/physics/world` | `2.0.1` | `packages/physics/src/world.ts` | 2 |
| `@aura3d/product-studio` | `2.0.1` | `packages/product-studio/src/index.ts` | 12 |
| `@aura3d/react` | `2.0.1` | `packages/react/src/index.ts` | 14 |
| `@aura3d/rendering` | `2.0.1` | `packages/rendering/src/index.ts` | 266 |
| `@aura3d/rendering/lean-runtime` | `2.0.1` | `packages/rendering/src/lean-runtime.ts` | 10 |
| `@aura3d/rendering/webgpu` | `2.0.1` | `packages/rendering/src/webgpu.ts` | 2 |
| `@aura3d/scene` | `2.0.1` | `packages/scene/src/index.ts` | 21 |
| `@aura3d/scripting` | `2.0.1` | `packages/scripting/src/index.ts` | 37 |
| `@aura3d/three-compat` | `2.0.1` | `packages/three-compat/src/index.ts` | 29 |
| `@aura3d/workflows` | `2.0.1` | `packages/workflows/src/index.ts` | 12 |
...
```ts
export type { AuraCanonicalAsset, AuraAssetLicense, AuraAssetLicenseSpdx, AuraAssetFormat, AuraAssetAccess, AuraAssetBounds, AuraAssetIntendedRole, } from "./CanonicalAsset.js";
...
export function readRenderedProbeMetadata(options: ReadRenderedProbeMetadataOptions): AuraCliRenderedProbe { const projectDir = resolve(options.projectDir ?? process.cwd());
export function addAsset(options: AddAssetOptions): AssetCliResult { const projectDir = resolve(options.projectDir ?? process.cwd());
export function bindGameRouteEvidence(options: BindGameRouteEvidenceOptions): BindGameRouteEvidenceResult { const projectDir = resolve(options.projectDir ?? process.cwd());
export async function certifyGameGeometry(options: CertifyGameGeometryOptions): Promise<GameGeometryCertificationResult> { const { probeShowcaseGameGeometry } = await import("create-aura3d");
...
export function checkDeploy(options: CheckDeployOptions = {}): AssetValidationResult { const projectDir = resolve(options.projectDir ?? process.cwd());
...
export { probeShowcaseGameGeometry, type ShowcaseGameGeometryCategory, type ShowcaseGameGeometryProbeResult } from "./showcase-spec-game-geometry-probe.js";
...
export { processInputValue } from "./InputValueProcessors";
export type { InputValueProcessor } from "./InputValueProcessors";
