...
Measured 2026-08-06 · 27 packages · graph acyclic · 0 undeclared dependencies · 0 layer violations.
...
|---|---|---|
| 0 | Foundation — zero Aura3D dependencies | `math`, `physics`, `scripting`, `test-utils`, `asset-index` |
...
| `test-utils` | 0 | 62 | not exported | shared test helpers | — |
