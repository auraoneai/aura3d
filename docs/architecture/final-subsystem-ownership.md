...
Generated from `tools/final-subsystem-ownership/index.mjs` at commit `c35141d7fad37107ee49c77b73557606d07a2d94`.
...
| `@aura3d/physics` | `COMPATIBILITY-ONLY` | 8071 | 47 | 3 | 102048 | yes |
| `@aura3d/physics-rapier` | `EXTERNAL-ADAPTER` | 186 | 6 | 1 | 2329 | yes |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| `animation-general` | `animation` | `AURA-CORE` | 43 | 7527 | 49680 | 198 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `asset-evidence-fixtures` | `assets` | `EVIDENCE-ONLY` | 1 | 65 | 674 | 4 | Remove evidence-only source from the published runtime after consumer proof. |
...
| `assets-general` | `assets` | `AURA-MOAT` | 61 | 15758 | 102750 | 228 | Retain under the package disposition; reassess only with consumer and migration evidence. |
| `audio-browser-runtime` | `audio` | `BROWSER-STANDARD` | 16 | 1696 | 8464 | 30 | Select one playback owner; retain Aura-specific cue semantics only. |
| `aura3d-cli-general` | `aura3d-cli` | `AURA-MOAT` | 31 | 8757 | 77735 | 791 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `create-aura3d-general` | `create-aura3d` | `AURA-MOAT` | 24 | 8574 | 69180 | 206 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `ecs-general` | `ecs` | `COMPATIBILITY-ONLY` | 30 | 1480 | 10078 | 83 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `editor-runtime-general` | `editor-runtime` | `OPTIONAL-PLUGIN` | 45 | 7537 | 47379 | 117 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `engine-general` | `engine` | `AURA-MOAT` | 105 | 54793 | 380791 | 868 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `environments-general` | `environments` | `AURA-CORE` | 9 | 464 | 3050 | 1336 | Retain under the package disposition; reassess only with consumer and migration evidence. |
| `input-general` | `input` | `AURA-CORE` | 24 | 1983 | 10744 | 73 | Retain under the package disposition; reassess only with consumer and migration evidence. |
| `materials-general` | `materials` | `AURA-CORE` | 10 | 339 | 2760 | 1338 | Retain under the package disposition; reassess only with consumer and migration evidence. |
| `math-general` | `math` | `AURA-CORE` | 19 | 1220 | 8067 | 176 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `physics-authored-arcade-motion` | `physics` | `AURA-MOAT` | 4 | 1597 | 5075 | 17 | Keep explicitly non-physical deterministic motion and sampling; never present it as rigid-body simulation. |
...
| `physics-general` | `physics` | `COMPATIBILITY-ONLY` | 10 | 2537 | 16083 | 427 | Retain under the package disposition; reassess only with consumer and migration evidence. |
| `physics-rapier-general` | `physics-rapier` | `EXTERNAL-ADAPTER` | 1 | 186 | 2329 | 0 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `rendering-general` | `rendering` | `AURA-CORE` | 252 | 54782 | 370830 | 898 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
| `scripting-general` | `scripting` | `COMPATIBILITY-ONLY` | 21 | 3692 | 25121 | 44 | Retain under the package disposition; reassess only with consumer and migration evidence. |
...
- **physical integration:** duplicate solver ownership remains until the major migration. Owners: cannon-es via PhysicsWorld, optional Rapier adapter.
