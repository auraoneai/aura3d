...
The getting-started path does not claim production PBR, environment lighting, large-scene culling, WebGPU hardware coverage, or a Unity/Unreal-style editor workflow. Those remain tracked by `docs/v2/filename-level-execution-checklist.md`.
