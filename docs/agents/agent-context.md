...
Superseded runtime documentation is removed from the current tree. Use Git
history only for archaeology; never restore historical APIs into active code
without a current ADR and public-contract evidence.
