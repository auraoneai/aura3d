# Cartoon Episode Production Workflow

This workflow describes the planned Aura3D 1.1 path from a cartoon idea to a reviewed episode package. It is intentionally narrower than a full animation studio: one short episode, typed assets, browser playback, render output, captions, evidence, and human review.
...
- route proof exposed on `window.__AURA3D_CARTOON_EPISODE_PROOF__`.
