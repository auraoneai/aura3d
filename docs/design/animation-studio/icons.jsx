/* Icon set — stroke icons, Lucide-ish. <Icon name="play" size={16}/> */
(function () {
  const P = {
    ...
    settings: 'M12 15a3 3 0 100-6 3 3 0 000 6z@M19 12a7 7 0 00-.1-1.3l2-1.5-2-3.4-2.3 1a7 7 0 00-2.3-1.3L16 2H8l-.3 2.2a7 7 0 00-2.3 1.3l-2.3-1-2 3.4 2 1.5a7 7 0 000 2.6l-2 1.5 2 3.4 2.3-1a7 7 0 002.3 1.3L8 22h8l.3-2.2a7 7 0 002.3-1.3l2.3 1 2-3.4-2-1.5A7 7 0 0019 12z',
  ...
  function Icon({ name, size = 16, sw = 1.8, style, className }) {
    const d = P[name];
    if (!d) return null;
    const parts = d.split('@');
  ...
  function Logo({ size = 30 }) {
    return React.createElement('div', { className: 'logo', style: { width: size, height: size } },
      React.createElement('svg', { width: size * 0.62, height: size * 0.62, viewBox: '0 0 24 24', fill: 'none' },
        React.createElement('path', { d: 'M12 2l9 16H3z', fill: 'none', stroke: '#fff', strokeWidth: 2, strokeLinejoin: 'round', opacity: .95 }),
        React.createElement('circle', { cx: 12, cy: 13, r: 3, fill: '#fff' }),
      )
    );
  }
  window.Icon = Icon;
