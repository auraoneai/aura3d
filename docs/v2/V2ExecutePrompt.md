...
You must continue iterating until the gates in `docs/v2/decision-gates.md` pass or until a hard technical blocker is documented with exact failing files, commands, reports, and next actions.
...
1. `docs/v2/README.md`
2. `docs/v2/current-feature-readiness.md`
3. `docs/v2/external-claim-requirements.md`
4. `docs/v2/subsystem-gap-roadmap.md`
5. `docs/v2/validation-and-benchmark-plan.md`
6. `docs/v2/documentation-examples-ecosystem-plan.md`
7. `docs/v2/filename-level-execution-checklist.md`
8. `docs/v2/decision-gates.md`
9. `docs/v2/claim-registry.md`
10. `docs/v2/V2ExecutePrompt.md`

Then run `rg --files docs/v2 -g '*.md'` and read any additional v2 markdown files that are not in the list above. The execution scope is all `docs/v2/*.md` source documents, not only this prompt.
...
When a task is completed, update the original source markdown file that owns the checkbox. "Original source markdown file" means the `.md` file where the task was originally defined, such as `docs/v2/filename-level-execution-checklist.md`, `docs/v2/decision-gates.md`, or another v2 source document. Do not mark only a copied checklist in a report, prompt, summary, or generated audit.
...
1. Identify the owning source checkbox with `rg -n "^- \\[ \\]" docs/v2`.
...
5. Run `rg -n "^- \\[ \\]" docs/v2` again and confirm that exact row no longer appears.
...
- Do not make public claims beyond `docs/v2/claim-registry.md`.
...
- `docs/v2/filename-level-execution-checklist.md` section 0 and master gates
...
- `examples/shadow-lab/**`
- renderer sections in `docs/v2/filename-level-execution-checklist.md`
...
- asset sections in `docs/v2/filename-level-execution-checklist.md`
...
- `examples/game-slice/**`
- runtime sections in `docs/v2/filename-level-execution-checklist.md`
...
- editor and Unity/Unreal workflow sections in `docs/v2/filename-level-execution-checklist.md`
...
- product demo, benchmark, documentation, and ecosystem sections in `docs/v2/filename-level-execution-checklist.md`
...
1. Run `rg -n "^- \\[ \\]" docs/v2`.
2. Run `rg -n "^- \\[x\\]" docs/v2`.
3. Run the relevant gate command for the completed slice.
4. Update reports.
5. If a claim is now enabled, update `docs/v2/claim-registry.md` with evidence and exclusions.
...
Until the gates pass, only claim what `docs/v2/claim-registry.md` allows.
...
1. `rg -n "^- \\[ \\]" docs/v2` returns no unchecked tasks, or every remaining unchecked task has a documented product decision or hard blocker.
2. All checked tasks have matching implementation, tests, examples/docs/reports, and passing commands.
3. Gate A in `docs/v2/decision-gates.md` passes.
4. Gate B in `docs/v2/decision-gates.md` passes.
...
8. `docs/v2/claim-registry.md` matches all public wording.
9. `docs/known-limits.md` is explicit and current.
