...
import { readJson } from "../v3-reporting/index.js";

const root = process.cwd();
const v3CorpusReport = readJson(root, "tests/reports/v3-asset-corpus.json");
const v3GltfCorpusReport = readJson(root, "tests/reports/v3-gltf-corpus.json");
const materialFidelityReport = readJson(root, "tests/reports/v3-asset-material-fidelity.json");
const report = createSubsystemReport(root, {
  subsystem: "asset-pipeline-and-content",
  command: "pnpm verify:v3-assets",
  reportPath: "tests/reports/v3-assets.json",
  runIdPrefix: "v3-assets",
  sourceFiles: [
  ...
  checks: [
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v3-asset-corpus.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v3-gltf-corpus.json"],
      blocker: "tests/reports/v3-gltf-corpus.json is not generated yet.",
    },
    {
      ...
      evidencePaths: ["tests/browser/asset-material-fidelity.spec.ts", "tests/reports/v3-asset-material-fidelity.json"],
