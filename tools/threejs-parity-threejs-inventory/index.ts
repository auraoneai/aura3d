...
const inventory: readonly InventoryItem[] = [
  ...
  item("misc_controls_trackball", "controls", "medium", "/apps/controls-trackball/", "matched", ["F", "K"], ["@galileo3d/controls exports TrackballControls and the V8 trackball route proves rotate, pan, dolly, and roll state driving a G3D-rendered camera example. TrackballControls now includes bounded damping plus keyboard pan, roll, and dolly handling through public control methods, with unit coverage for the damped update path and browser coverage proving the rendered interaction route stays live beyond a one-click smoke test."], [], ["tests/unit/controls/three-compat-controls.test.ts", "tests/browser/current-routes-animation-examples.spec.ts"], ["tests/reports/current-routes/controls/trackball.png"]),
  item("misc_controls_transform", "controls", "high", "/apps/controls-transform/", "matched", ["F", "K"], ["@galileo3d/controls exports public TransformControls, the dedicated V8 Transform Controls route applies translate/rotate/scale operations to a rendered G3D scene object through that public API, and unit parity compares the same translate/rotate/scale sequence against actual Three.js TransformControls object mutation semantics."], [], ["tests/unit/controls/transform-controls-three-parity.test.ts", "tests/unit/controls/three-compat-controls.test.ts", "tests/browser/threejs-parity-transform-controls.spec.ts"], ["tests/reports/threejs-parity/transform-controls/transform-controls.png"]),
...
const report = {
  schema: "g3d-threejs-parity-threejs-inventory/v1",
