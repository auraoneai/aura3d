...
const rounds: RoundEvidence[] = [
  ...
  round("Round 12: Diagnostics And Screenshot Quality", reportPass("tests/reports/package-clean-install.json") && reportPass("tests/reports/agent-devtools.json") && existsSync("docs/project/starter-template-visual-review.md") && existsSync("docs/project/starter-example-visual-review.md") ? "automated-pass" : "partial", ["tests/reports/package-clean-install.json", "tests/reports/agent-devtools.json", "tests/reports/error-message-quality.json", "docs/project/starter-template-visual-review.md", "docs/project/starter-example-visual-review.md"]),
