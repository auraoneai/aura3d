...
const rounds: RoundEvidence[] = [
  ...
  round("Round 9: Asset Corpus Validation", reportPass("tests/reports/asset-corpus.json") ? "partial" : "external-gap", ["docs/project/asset-corpus-results.md", "tests/reports/asset-corpus.json"], "Generated/adversarial corpus is proven; licensed wild Sketchfab/Poly Haven/Meshy/Blender/Draco assets remain external corpus work."),
  ...
  round("Round 12: Diagnostics And Screenshot Quality", reportPass("tests/reports/package-clean-install.json") && reportPass("tests/reports/agent-devtools.json") ? "automated-pass" : "partial", ["tests/reports/package-clean-install.json", "tests/reports/agent-devtools.json", "tests/reports/error-message-quality.json"]),
  round("Round 13: Static Deployment Checks", reportPass("tests/reports/agent-deployment.json") ? "partial" : "external-gap", ["tests/reports/agent-deployment.json", "tests/reports/package-clean-install.json"], "Local static/deploy checks are proven; real Vercel, Cloudflare Pages, and Netlify deployments remain external account work."),
  ...
  round("Round 19: Product Rebuild From Context Alone", existsSync("docs/project/fresh-codex-agent-context-results.md") ? "manual-pass" : "partial", ["docs/project/fresh-codex-agent-context-results.md"]),
