...
const reportDir = resolve("tests/reports/v4-external-vite-build");
const staticPreviewRoot = resolve("tests/reports/v4-static-preview");
const reportPath = resolve("tests/reports/v4-external-vite-build.json");
const templates = [
...
try {
  ...
  const report = {
    schema: "g3d-v4-external-vite-build/v1",
