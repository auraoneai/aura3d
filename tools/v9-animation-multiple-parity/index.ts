...
import { sampleAgentPoses, spawnAgents, type AgentPose } from "/apps/v8-animation-multiple/src/agentSpawner.ts";
...
const ASSET = {
  ...
  url: "/fixtures/v8/assets/character/soldier.glb",
  width: 720,
  height: 480
} as const;
...
async function run(): Promise<void> {
  ...
  try {
    ...
    const ready: AnimationMultipleParityReady = {
      status: "ready",
      schema: "g3d-v9-animation-multiple-parity/v1",
