...
import { createV6AssetCorpusSummary, loadV6AssetManifest } from '../../packages/assets/src/v6/V6AssetCorpus';
import { createV6EnvironmentCorpusSummary, loadV6EnvironmentManifest } from '../../packages/environments/src/v6/V6EnvironmentCorpus';
...
export function writeVisualQualityReports(): void {
  copyScreenshot('tests/reports/v6-gallery/product/product-configurator-webgpu.png', 'tests/reports/v6-gallery/webgpu/webgpu-product-frame.png');
  copyScreenshot('tests/reports/v6-app-suite/v6-threejs-parity-lab.png', 'tests/reports/v6-gallery/assets/boom-box-webgl2.png');
  copyScreenshotIfNeeded('tests/reports/v6-gallery/materials/material-extension-grid-webgl2.png', 'tests/reports/v6-gallery/materials/pbr-material-extension-grid.png');
  const gallery = readJson('tests/reports/v6-gallery/manifest.json');
  ...
  const requiredScreenshotChecks = v6RequiredGalleryScreenshots.map((screenshot) => {
  ...
  writeJsonReport('tests/reports/v6-visual-quality.json', {
    schema: 'g3d-v6-visual-quality/v2',
  ...
  writeJsonReport('tests/reports/v6-real-renderer-proof.json', {
    schema: 'g3d-v6-real-renderer-proof/v2',
    generatedAt: new Date().toISOString(),
    pass,
  ...
  writeJsonReport('tests/reports/v6-human-visual-review.json', {
    schema: 'g3d-v6-human-visual-review/v2',
    generatedAt: new Date().toISOString(),
    pass,
...
const v6RequiredGalleryScreenshots = [
...
export function writeThreeJsParityReports(): void { const readiness = readJson('tests/reports/v6-threejs-parity-readiness.json'); writeJsonReport('tests/reports/v6-threejs-visual-parity.json', { schema: 'g3d-v6-threejs-visual-parity/v1', generatedAt: new Date().toISOString(), pass: readiness.pass === true, sourceReport: 'tests/reports/v6-threejs-parity-readiness.json' }); writeJsonReport('tests/reports/v6-threejs-runtime-parity.json', { schema: 'g3d-v6-threejs-runtime-parity/v1', generatedAt: new Date().toISOString(), pass: readiness.pass === true, sourceReport: 'tests/reports/v6-threejs-parity-readiness.json' }); }
export function writeWorkflowReadiness(): Json { return bridgeReport('tests/reports/v6-workflows-readiness.json', 'tests/reports/v6-workflow-readiness.json', 'g3d-v6-workflow-readiness/v1'); }
