...
const report = {
  schema: "g3d-v5-threejs-inventory/v1",
...
writeJson("tests/reports/v5-threejs-inventory.json", report);
writeJson("tests/reports/v5-threejs-compatibility-matrix.json", matrix);
