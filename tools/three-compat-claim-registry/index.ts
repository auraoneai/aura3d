...
const claims = [
  {
    ...
    evidence: ["docs/project/parity/threejs/status.md", "docs/project/status/known-limits.md", "docs/project/status/known-limits.md"]
  },
  {
    id: "full-threejs-api-parity",
    status: "blocked",
    claim: "A3D fully replaces the Three.js API.",
    evidence: ["docs/project/status/known-limits.md", "docs/project/status/known-limits.md"]
  },
  {
...
const blockedDocs = ["docs/project/status/known-limits.md", "docs/project/status/known-limits.md"]
