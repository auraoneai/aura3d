...
const claimGateReport = readJson(root, "tests/reports/v3-claim-gates.json");
const webgpuHardwareMatrix = readJson(root, "tests/reports/webgpu-hardware-matrix.json");
const webgpuParityReport = readJson(root, "tests/reports/v3-webgpu-parity.json") ?? readJson(root, "tests/reports/webgpu-parity.json");
const browserMatrix = readJson(root, "tests/reports/v3-browser-matrix.json");
const browserRenderingReport = readJson(root, "tests/reports/v3-rendering.json");
...
const baseReport = createSubsystemReport(root, {
  ...
  command: "pnpm verify:v3-rendering",
  reportPath: "tests/reports/v3-rendering.json",
  runIdPrefix: "v3-rendering",
  sourceFiles: [
    ...
    "tests/reports/v3-webgpu-parity.json",
    "tests/reports/v3-browser-matrix.json",
  ...
  checks: [
    ...
    },
    {
      ...
      evidencePaths: ["packages/rendering/src/PostProcessPass.ts", "examples/postprocess-lab/main.ts", "examples/material-showroom/main.ts", "tests/browser/rendering-v3-labs.spec.ts", "tests/reports/v3-rendering.json"],
    ...
    },
    {
      ...
      evidencePaths: ["packages/rendering/src/PostProcessPass.ts", "examples/material-showroom/main.ts", "tests/browser/rendering-v3-labs.spec.ts", "tests/reports/v3-rendering.json"],
    ...
    },
    {
      ...
      evidencePaths: ["packages/rendering/src/RendererFeatureGates.ts", "tests/reports/v3-rendering.json"],
    ...
    },
    {
      ...
      evidencePaths: ["examples/webgpu-capability/index.html", "examples/webgpu-capability/main.ts", "tests/browser/rendering-v3-labs.spec.ts"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/browser/webgpu-parity.spec.ts", "tests/reports/v3-webgpu-parity.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/webgpu-hardware-matrix.json", "tests/reports/v3-claim-gates.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tools/v3-browser-matrix/index.ts", "tests/reports/v3-browser-matrix.json"],
...
writeJson(root, "tests/reports/v3-rendering.json", report);
