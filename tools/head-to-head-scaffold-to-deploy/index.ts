...
const checks = [
  ...
  { id: "public-installed-entry-only", pass: auraSource.includes('from "@aura3d/engine/lean-product"') && !auraSource.includes("packages/") && threeSource.includes('from "@react-three/fiber"') && threeSource.includes('from "@react-three/drei"') && threeSource.includes('from "three"') },
