...
const browserReportPath = resolve("tests/reports/v6-webgl2-real-renderer.json");
const screenshotPath = resolve("tests/reports/v6-webgl2/damaged-helmet-webgl2.png");
const reportPath = resolve("tests/reports/v6-webgl2-readiness.json");
...
const report = {
  schema: "g3d-v6-webgl2-readiness/v1",
