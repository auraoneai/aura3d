import { countChecklist, listUncheckedChecklist, readInventory, reportIssue, writeJson } from "../v9-common";

const outputPath = "tests/reports/v9/completion-audit.json";
...
writeJson(outputPath, {
  schema: "g3d-v9-completion-audit/v1",
