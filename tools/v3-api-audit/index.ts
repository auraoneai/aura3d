...
export interface V3ApiAuditReport {
  readonly schema: "g3d-v3-api-audit/v1";
...
export function writeV3ApiAuditReport(workspaceRoot = root, outputPath = "tests/reports/v3-api-audit.json"): V3ApiAuditReport {
...
if (process.argv[1] && process.argv[1].endsWith("tools/v3-api-audit/index.ts")) {
