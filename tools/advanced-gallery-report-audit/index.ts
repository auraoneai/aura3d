...
const defaultReportDir = ADVANCED_GALLERY_CONTEXTUAL_REPORT_DIR;
...
const generatedAssetManifestRequirements = [
  {
    ...
    outputKey: "glb",
    expectedOutputPath: "fixtures/advanced-gallery/assets/product-configurator-studio-blender/product-configurator-studio-blender.glb",
    expectedSourceScript: "tools/advanced-gallery-assets/generate-product-configurator-studio-blender.py",
  ...
  },
  {
    ...
    outputKey: "glb",
    expectedOutputPath: "fixtures/advanced-gallery/assets/product-configurator-car-batched/car-concept-batched.glb",
    expectedSourceScript: "tools/advanced-gallery-assets/optimize-product-car-blender.py",
    requireGeneratedNoTexture: false,
    requireDerivative: true,
    expectedSourceAssetPath: "fixtures/threejs-parity/assets/vehicles/car-concept.glb"
  },
  {
    routeId: "data-galaxy",
    ...
    outputKey: "glb",
    expectedOutputPath: "fixtures/advanced-gallery/assets/data-galaxy-core-blender/data-galaxy-core-blender.glb",
    expectedSourceScript: "tools/advanced-gallery-assets/generate-data-galaxy-core-blender.py",
    requireGeneratedNoTexture: false,
    requireDerivative: false,
    expectedSourceAssetPath: undefined
  }
