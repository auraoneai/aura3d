import { issue, readThreeJsParityInventory, reportPasses, writeReport } from "../superiority-common";

const outputPath = "tests/reports/superiority/animation-fidelity.json";
...
writeReport(outputPath, {
  schema: "a3d-superiority-animation-fidelity",
