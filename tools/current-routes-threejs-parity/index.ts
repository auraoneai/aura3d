...
async function validateNodeReport(): Promise<void> {
  ...
  const result = {
    schema: "g3d-current-routes-threejs-parity-node-validation/v1",
...
async function run(): Promise<void> {
  ...
  try {
    ...
    const galileo = await withTimeout(
      import("../../benchmarks/galileo/src/scenes/current-routes-flagship-viewer") as Promise<GalileoModule>,
      45_000,
    ...
    const ready: V8ThreejsParityReady = {
      status: "ready",
      schema: "g3d-current-routes-threejs-parity/v1",
