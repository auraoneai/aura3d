...
const checks = [
  ...
  { id: "a3d-real-renderer-proof", pass: results.length >= 12 && results.every((result) => result.a3d?.pass === true && (result.a3d.drawCalls ?? 0) > 0 && (result.a3d.nonBlackPixels ?? 0) > 1000 && (result.a3d.uniqueColorBuckets ?? 0) >= 50), detail: failed(results, (result) => !(result.a3d?.pass === true && (result.a3d.drawCalls ?? 0) > 0 && (result.a3d.nonBlackPixels ?? 0) > 1000 && (result.a3d.uniqueColorBuckets ?? 0) >= 50)) },
