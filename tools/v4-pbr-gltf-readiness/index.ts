...
export function createV4PbrGltfReadinessReport(root = process.cwd()): V4PbrGltfReadinessReport {
  ...
  const validationRows = [
    validation("pbr-material-and-environment-browser-evidence", pbrMaterialEnvironmentBrowserEvidence, "tests/reports/v4-rendering.json + tests/reports/v4-asset-material-fidelity.json + tests/browser/rendering-root-quality-gate.spec.ts", [
