...
const browserReportPath = resolve("tests/reports/production-runtime-pbr-hdr-real-renderer.json");
const reportPath = resolve("tests/reports/production-runtime-pbr-hdr-readiness.json");
const screenshotPaths = [
  resolve("tests/reports/production-runtime-pbr-hdr/damaged-helmet-studio-hdr.png"),
  resolve("tests/reports/production-runtime-pbr-hdr/damaged-helmet-sunset-hdr.png")
];
...
const report = {
  schema: "g3d-production-runtime-pbr-hdr-readiness/v1",
