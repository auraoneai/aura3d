...
const reportPath = resolve("tests/reports/production-runtime-gltf-render-readiness.json");
const browserReportPath = resolve("tests/reports/production-runtime-gltf-render-real-renderer.json");
...
const report = {
  schema: "a3d-production-runtime-gltf-render-readiness",
