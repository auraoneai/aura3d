...
const checks = [
  { name: "required-benchmark-dirs", pass: ["benchmarks/three-compat/shared", "benchmarks/three-compat/galileo", "benchmarks/three-compat/threejs"].every((dir) => existsSync(resolve(dir))), detail: "benchmark directories exist" },
...
const report = { schema: "g3d-three-compat-threejs-runtime-parity/v1", generatedAt: new Date().toISOString(), pass, comparisons, checks };
