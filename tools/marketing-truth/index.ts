...
const checks: ReleaseCheck[] = [
  ...
  fileIncludes("marketing/index.html", ["Aura3D 2.0.3 is live", "36 apps, games, and focused examples", "29 coordinated packages at 2.0.3", "Rapier physics", "Recast navigation", "Build your first scene"], "marketing product-first release copy"),
