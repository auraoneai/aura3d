...
import { pathExists, reportOk, type V3EvidenceCheck } from "../v3-subsystem-report/index.js";
import { baseReport, isRecord, readJson, writeJson } from "../v3-reporting/index.js";

const root = process.cwd();
const comparisonReport = readJson(root, "tests/reports/v3-engine-comparison.json");
...
const sourceFiles = [
  ...
  "tests/reports/v3-comparison-threejs.json",
  "tests/reports/v3-comparison-babylon.json",
...
const checks: readonly V3EvidenceCheck[] = [
  {
    ...
    passed: reportOk(root, "tests/reports/v3-comparison-threejs.json"),
    evidencePaths: ["tests/reports/v3-comparison-threejs.json"],
  ...
  },
  {
    ...
    passed: reportOk(root, "tests/reports/v3-comparison-babylon.json"),
    evidencePaths: ["tests/reports/v3-comparison-babylon.json"],
  ...
  },
  {
    ...
    evidencePaths: ["tests/reports/v3-engine-comparison.json"],
  ...
  },
  {
    ...
    evidencePaths: ["tests/reports/v3-engine-comparison.json", "tests/browser/engine-comparison.spec.ts"],
  ...
  },
  {
    ...
    evidencePaths: ["benchmarks/shared/scenes/editor-authored-startup.ts", "examples/editor-authored-v3-app/project.json", "tests/reports/v3-editor-authoring.json", "tests/reports/v3-engine-comparison.json"],
  ...
  },
  {
    ...
    evidencePaths: ["tests/reports/v3-engine-comparison.json", "tests/reports/comparison-screenshots"],
...
const base = baseReport(root, {
  ...
  command: "pnpm verify:v3-benchmarks",
  runIdPrefix: "v3-benchmarks",
  sourceFiles,
  screenshotPaths,
  violations,
});
...
writeJson(root, "tests/reports/v3-engine-comparison.json", report);
