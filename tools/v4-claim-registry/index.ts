...
const report = {
  schema: "g3d-v4-claim-registry/v1",
...
mkdirSync(dirname(resolve("tests/reports/v4-claim-registry.json")), { recursive: true });
writeFileSync(resolve("tests/reports/v4-claim-registry.json"), `${JSON.stringify(report, null, 2)}\n`);
if (!pass) {
