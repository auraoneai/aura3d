...
const requiredFiles = [
  ...
  "docs/project/v5-roadmap-postprocess-migration.md",
...
const checks: V5PostprocessCheck[] = [
  ...
  check("migration-doc", existsSync(resolve("docs/project/v5-roadmap-postprocess-migration.md")), "postprocess migration doc exists"),
  check("browser-screenshots", existsSync(resolve("tests/reports/v5-postprocess-before.png")) && existsSync(resolve("tests/reports/v5-postprocess-after.png")), "before/after screenshots exist")
];

const pass = checks.every((item) => item.pass);
const report = {
  schema: "g3d-v5-postprocess-readiness/v1",
...
const reportPath = resolve("tests/reports/v5-postprocess-readiness.json");
