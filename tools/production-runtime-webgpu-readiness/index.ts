...
const checks = [
  ...
  { id: "schema", pass: browserReport?.schema === "a3d-production-runtime-webgpu-report/v1", detail: browserReport?.schema ?? "missing" },
...
const report = {
  schema: "a3d-production-runtime-webgpu-readiness/v1",
