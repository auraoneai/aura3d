...
const matrixPath = "tests/reports/v5-threejs-compatibility-matrix.json";
...
const report = {
  schema: "g3d-v5-compatibility-matrix-readiness/v1",
...
mkdirSync(dirname(resolve("tests/reports/v5-compatibility-matrix-readiness.json")), { recursive: true });
writeFileSync(resolve("tests/reports/v5-compatibility-matrix-readiness.json"), `${JSON.stringify(report, null, 2)}\n`);
