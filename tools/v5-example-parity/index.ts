...
const catalog = JSON.parse(readFileSync(resolve("examples/v5/catalog.json"), "utf8")) as {
...
const report = {
  schema: "g3d-v5-example-parity/v1",
...
const reportPath = resolve("tests/reports/v5-example-parity.json");
