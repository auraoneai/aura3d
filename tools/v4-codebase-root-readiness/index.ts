...
const reportPath = "tests/reports/v4-codebase-root-readiness.json";
...
export function evaluateV4CodebaseRootReadinessGate(options: V4CodebaseRootReadinessGateOptions): {
  ...
  const visualBlockers = options.visualQualityOk ? [] : ["visual-quality: tests/reports/v4-visual-quality.json is missing or failing"];
...
export function createV4CodebaseRootReadinessReport(root = process.cwd()) {
  ...
  const broadParity = readJson(root, "tests/reports/v4-broad-parity-readiness.json");
  const completionAudit = readJson(root, "tests/reports/v4-completion-audit.json");
  ...
  const v4RenderPresetUnitSpec = readText(root, "tests/unit/rendering/v4-render-preset.test.ts");
  ...
  const visualQualityToolSource = readText(root, "tools/v4-visual-quality/index.ts");
  ...
  const checks: readonly RootCheck[] = [
    ...
    check(
      ...
      [
        ...
        "tests/reports/v4-root-rendering-quality/lit-multi-material-scene.png",
        "tests/reports/v4-root-rendering-quality/authored-camera-movement.png",
        "tests/reports/v4-root-rendering-quality/dense-camera-framing.png"
      ],
    ...
    check(
      ...
      ["packages/rendering/src/V4RenderPreset.ts", "tests/unit/rendering/v4-render-preset.test.ts"],
    ...
    check(
      ...
      [
        ...
        "tests/browser/rendering-root-quality-gate.spec.ts",
        "tests/reports/v4-root-rendering-quality.json",
        "tests/reports/v4-root-rendering-quality/pbr-material-scalar-dielectric.png",
        "tests/reports/v4-root-rendering-quality/pbr-material-scalar-metallic.png",
        "tests/reports/v4-root-rendering-quality/advanced-textured-pbr-clearcoat.png",
    ...
    check(
      ...
      ["tests/reports/v4-pbr-gltf-readiness.json", "packages/assets/src/GLTFRenderResources.ts"],
    ...
    check(
      ...
      [
        "tests/browser/rendering-root-quality-gate.spec.ts",
        "tests/reports/v4-root-rendering-quality.json",
        "tests/reports/v4-root-rendering-quality/postprocess-suite-integrated.png",
    ...
    check(
      ...
      ["tests/browser/rendering-root-quality-gate.spec.ts", "tests/reports/v4-root-rendering-quality.json", "tests/reports/v4-hdr-render-target-readiness.json"],
    ...
    check(
      ...
      ["packages/rendering/src/ForwardPass.ts", "packages/rendering/src/ShadowPass.ts", "tests/reports/v4-root-rendering-quality.json", "tests/reports/v4-shadow-map-readiness.json"],
    ...
    check(
      ...
      ["packages/rendering/src/WebGPUDevice.ts", "tests/browser/webgpu-parity.spec.ts", "tests/reports/v4-webgpu-parity.json"],
  ...
  const report = {
    ...baseReport(root, {
      ok: gate.rootReady,
      command: "pnpm verify:v4-codebase-root",
      runIdPrefix: "v4-codebase-root-readiness",
      sourceFiles: [
        "tools/v4-codebase-root-readiness/index.ts",
        ...
        "tests/reports/v4-root-rendering-quality.json",
        "tests/reports/v4-visual-quality.json",
        "tests/reports/v4-example-visual-review.json",
...
function buildPromptToArtifactChecklist(context: {
  ...
  return [
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-pbr-gltf-readiness.json", "packages/assets/src/GLTFLoader.ts", "packages/assets/src/GLTFRenderResources.ts"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-pbr-gltf-readiness.json", "tests/reports/v4-pbr-reference-readiness.json", "tests/reports/v4-pbr-visual-parity.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-hdr-render-target-readiness.json", "tests/reports/v4-root-rendering-quality.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-shadow-map-readiness.json", "tests/reports/v4-root-rendering-quality.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-postprocess-suite.json", "tests/reports/v4-root-rendering-quality.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-codebase-root-readiness.json"],
    ...
    },
    {
      ...
      evidencePaths: ["tests/reports/v4-visual-quality.json", "tests/reports/v4-example-visual-review.json"],
...
function completionAuditBlockers(report: Record<string, unknown> | null): string[] {
  if (!isRecord(report)) return ["completion: tests/reports/v4-completion-audit.json is missing"];
...
function broadParityBlockers(report: Record<string, unknown> | null): string[] {
  if (!isRecord(report)) return ["broad-parity: tests/reports/v4-broad-parity-readiness.json is missing"];
...
function externalEvidenceBlockers(report: Record<string, unknown> | null): string[] {
  if (!isRecord(report)) return ["external-evidence: tests/reports/v4-external-evidence-readiness.json is missing"];
