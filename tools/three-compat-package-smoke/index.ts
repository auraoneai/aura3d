...
const reportDir = resolve("tests/reports/three-compat-external-consumer");
mkdirSync(reportDir, { recursive: true });
const packRoot = resolve("tests/reports/three-compat-external-consumer/pack-root");
...
const installDir = resolve("tests/reports/three-compat-external-consumer/temp-app");
...
const reportPath = resolve("tests/reports/three-compat-package-smoke.json");
