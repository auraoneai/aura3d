...
const REPORT_PATH = "tests/reports/v8-legacy-prune.json";
...
const blockedLegacyPaths: readonly LegacyEntry[] = [
  { path: "examples/product-configurator/", phase: "docs/project/v4-engine-readiness-plan.md/docs/project/v4-roadmap-visual-engine-plan.md", reason: "Unversioned product demo was replaced by versioned product viewer routes.", replacement: "examples/v5/product-configurator/", quarantinePath: "examples/_quarantine/product-configurator/" },
  { path: "examples/postprocess-lab/", phase: "docs/project/v4-engine-readiness-plan.md/docs/project/v4-roadmap-visual-engine-plan.md", reason: "Unversioned postprocess lab was replaced by versioned postprocess examples.", replacement: "examples/v5/postprocess-bloom/", quarantinePath: "examples/_quarantine/postprocess-lab/" },
  { path: "examples/shadow-lab/", phase: "docs/project/v4-engine-readiness-plan.md", reason: "Unversioned shadow lab is legacy renderer evidence.", replacement: "examples/v5/architecture-interior/", quarantinePath: "examples/_quarantine/shadow-lab/" },
  { path: "examples/portfolio/", phase: "docs/project/v2-roadmap-product-asset-pipeline-plan.md", reason: "Static screenshot portfolio must not be used as product proof.", replacement: "tests/reports/v8/", quarantinePath: "examples/_quarantine/portfolio/" },
  { path: "examples/architecture-viewer/", phase: "docs/project/v3-roadmap-product-workflow-plan.md", reason: "Unversioned architecture viewer was replaced by versioned architecture routes.", replacement: "apps/v6-architecture-viewer/", quarantinePath: "examples/_quarantine/architecture-viewer/" },
  ...
  { path: "examples/portfolio/screenshots/", phase: "docs/project/v2-roadmap-product-asset-pipeline-plan.md", reason: "Old static screenshots are failed evidence.", replacement: "tests/reports/v8/" }
] as const;

const retainedHistoricalArtifacts = [
  "tests/reports/example-portfolio-screenshots/",
  "tests/reports/v4-gallery/",
  "tests/reports/v5-gallery/",
  "tests/reports/v6-gallery/",
  "tests/reports/v7/"
] as const;
...
const currentEvidenceFiles = [
  ...
  "tests/reports/v8-flagship-viewer.json",
...
export function createV8LegacyPruneReport(): Record<string, unknown> {
  ...
  const internalStressLinks = rootLinks.filter((link) => link.path === "/apps/v7-example-parity-lab/" && link.linked);
