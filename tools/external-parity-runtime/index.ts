...
const checks = [
  ...
  check("arcade-character-camera-input", metrics.characterController === true && metrics.characterControllerMode === "authored-unit-arcade" && metrics.cameraMode === "third-person-follow" && numberAt(metrics, "scriptHookInput") >= 3, [reportPath, "packages/physics/src/ArcadeCharacterController.ts", "examples/game-slice/main.ts"], "Authored-unit arcade character, camera, and input evidence is incomplete."),
  ...
  check("runtime-script-hooks", numberAt(metrics, "scriptHookInit") >= 1 && numberAt(metrics, "scriptHookUpdate") > 0 && numberAt(metrics, "scriptHookFixedUpdate") > 0 && numberAt(metrics, "scriptHookTrigger") >= 1 && numberAt(metrics, "scriptHookTeardown") >= 1, [reportPath, "examples/game-slice/main.ts"], "Runtime init/update/fixed-update/trigger/teardown hook evidence is incomplete."),
