...
const requiredFiles = [
  ...
  "tests/reports/v4-material-matrix-browser.json"
] as const;
...
const browser = readJson("tests/reports/v4-material-matrix-browser.json");
...
const report = {
  schema: "g3d-v4-pbr-readiness/v1",
...
const reportPath = resolve("tests/reports/v4-pbr-readiness.json");
