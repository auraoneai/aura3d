...
interface V5MaterialManifest {
  readonly schema: "g3d-v5-material-library/v1";
...
const manifest = JSON.parse(readFileSync(resolve("fixtures/v5/materials/manifest.json"), "utf8")) as V5MaterialManifest;
...
const checks: V5MaterialReadinessCheck[] = [
  ...
  check("schema", manifest.schema === "g3d-v5-material-library/v1", `schema=${manifest.schema}`),
  check(
    "material-floor",
...
const report = {
  schema: "g3d-v5-material-readiness/v1",
...
const reportPath = resolve("tests/reports/v5-material-readiness.json");
