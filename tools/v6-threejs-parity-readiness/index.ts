...
const reportPath = resolve("tests/reports/v6-threejs-parity-readiness.json");
const browserReportPath = resolve("tests/reports/v6-threejs-parity/browser-report.json");
...
const report = {
  schema: "g3d-v6-threejs-parity-readiness/v1",
