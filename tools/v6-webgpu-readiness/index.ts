...
const browserReportPath = resolve("tests/reports/v6-webgpu-browser-report.json");
const reportPath = resolve("tests/reports/v6-webgpu-readiness.json");
...
const checks = [
  ...
  { id: "schema", pass: browserReport?.schema === "g3d-v6-webgpu-report/v1", detail: browserReport?.schema ?? "missing" },
...
const report = {
  schema: "g3d-v6-webgpu-readiness/v1",
