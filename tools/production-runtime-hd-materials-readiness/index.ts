...
const reportPath = resolve("tests/reports/production-runtime-hd-materials.json");
const readinessPath = resolve("tests/reports/production-runtime-hd-materials-readiness.json");
const expectedScreenshot = "tests/reports/production-runtime-hd-materials/pbr-materials-hd.png";
...
const readiness = {
  schema: "a3d-production-runtime-hd-materials-readiness",
