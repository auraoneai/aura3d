...
const reportPath = "tests/reports/v4-shadow-visual-parity.json";
const artifactDir = "tests/reports/v4-shadow-visual-parity";
const sourceFiles = [
    ...
    try {
      ...
      return {
        ...baseReport(root, {
          ...
          command: "pnpm audit:v4-shadow-visual-parity",
          runIdPrefix: "v4-shadow-visual-parity",
          sourceFiles,
          screenshotPaths,
          violations,
          blockedClaims: [
