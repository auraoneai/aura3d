...
import { V4_THREEJS_PARITY_SCENES } from "../../benchmarks/v4/shared/threejs-visual-parity-scenes";

type Obj = Record<string, unknown>;
interface Check { readonly id: string; readonly pass: boolean; readonly detail: string; }

const reportDir = "tests/reports/v4-threejs-visual-parity";
...
const report = {
  schema: "g3d-v4-threejs-visual-parity/v1",
...
mkdirSync(dirname(resolve("tests/reports/v4-threejs-visual-parity.json")), { recursive: true });
writeFileSync(resolve("tests/reports/v4-threejs-visual-parity.json"), `${JSON.stringify(report, null, 2)}\n`);
if (!pass) {
