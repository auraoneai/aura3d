...
const reportPath = resolve("tests/reports/v6-hd-product-hero.json");
const readinessPath = resolve("tests/reports/v6-hd-product-hero-readiness.json");
const expectedScreenshot = "tests/reports/v6-hd-product-hero/damaged-helmet-hero.png";
...
const readiness = {
  schema: "g3d-v6-hd-product-hero-readiness/v1",
