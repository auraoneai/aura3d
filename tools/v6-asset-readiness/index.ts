...
import { createV6AssetCorpusSummary } from "../../packages/assets/src/v6";
import { createV6EnvironmentCorpusSummary } from "../../packages/environments/src/v6";

const reportPath = resolve("tests/reports/v6-asset-readiness.json");
const assetSummary = createV6AssetCorpusSummary();
const environmentSummary = createV6EnvironmentCorpusSummary();
const report = {
  schema: "g3d-v6-asset-environment-readiness/v1",
