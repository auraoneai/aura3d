...
const outputPath = "tests/reports/superiority/resource-lifecycle-100-reloads.json";

interface LifecycleReport {
  readonly schema: "a3d-superiority-resource-lifecycle-100-reloads";
...
async function runLifecycleEvidence(reloads = 100): Promise<LifecycleReport> {
  ...
  return {
    schema: "a3d-superiority-resource-lifecycle-100-reloads",
