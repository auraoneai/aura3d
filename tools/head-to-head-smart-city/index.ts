...
const checks = [
  ...
  { id: "native-city-tower-instancing", pass: browser.before?.aura?.nativeInstancedSubmissions > 0 && browser.after?.aura?.nativeInstancedSubmissions > 0 && browser.before?.three?.instancedMeshCount === 8 && browser.after?.three?.instancedMeshCount === 8 },
