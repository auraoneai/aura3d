...
const requiredFiles = [
  ...
  "tests/browser/fixtures/v4-public-api-app/index.html",
  "tests/browser/fixtures/v4-public-api-app/main.ts",
...
const workflowEntrypoint = text("packages/workflows/src/v4/index.ts");
check(
  "api-surface",
...
const browser = json("tests/reports/v4-public-api-app-browser.json");
...
const report = {
  schema: "g3d-v4-api-readiness/v1",
...
mkdirSync(dirname(resolve("tests/reports/v4-api-readiness.json")), { recursive: true });
writeFileSync(resolve("tests/reports/v4-api-readiness.json"), `${JSON.stringify(report, null, 2)}\n`);
if (!pass) {
