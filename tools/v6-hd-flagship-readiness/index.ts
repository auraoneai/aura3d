...
const reportPath = resolve("tests/reports/v6-hd-flagship.json");
const readinessPath = resolve("tests/reports/v6-hd-flagship-readiness.json");
const expectedScreenshot = "tests/reports/v6-hd-flagship/composed-product-hd.png";
...
const readiness = {
  schema: "g3d-v6-hd-flagship-readiness/v1",
