...
const screenshotDir = "tests/reports/v5-threejs-visual-parity";
...
const report = { schema: "g3d-v5-threejs-visual-parity/v2", generatedAt: new Date().toISOString(), pass, comparisons, visualValidations, checks };
const reportPath = resolve("tests/reports/v5-threejs-visual-parity.json");
