...
const manifestPath = resolve("fixtures/production-runtime/gallery-manifest.json");
const generatedManifestPath = resolve("tests/reports/production-runtime-gallery/manifest.json");
const reportPath = resolve("tests/reports/production-runtime-gallery-readiness.json");
...
const normalizedGalleryPaths: Record<string, string> = {
  "webgl2-damaged-helmet": "tests/reports/production-runtime-gallery/assets/damaged-helmet-webgl2.png",
  "pbr-hdr-studio": "tests/reports/production-runtime-gallery/product/product-configurator-webgl2.png",
  "pbr-hdr-sunset": "tests/reports/production-runtime-gallery/architecture/architecture-night-webgl2.png",
  "gltf-damaged-helmet": "tests/reports/production-runtime-gallery/assets/damaged-helmet-gltf-webgl2.png",
  "gltf-clearcoat": "tests/reports/production-runtime-gallery/materials/material-extension-grid-webgl2.png",
  "gltf-cesium-man": "tests/reports/production-runtime-gallery/character/animated-character-gltf-webgl2.png",
  "effects-damaged-helmet": "tests/reports/production-runtime-gallery/postprocess/cinematic-after-webgl2.png",
  "animation-cesium-man": "tests/reports/production-runtime-gallery/character/animated-character-webgl2.png",
  "app-product-configurator": "tests/reports/production-runtime-gallery/product/product-app-webgl2.png",
  "app-automotive-configurator": "tests/reports/production-runtime-gallery/automotive/automotive-configurator-webgl2.png",
  "app-architecture-viewer": "tests/reports/production-runtime-gallery/architecture/architecture-day-webgl2.png",
  "app-asset-inspector": "tests/reports/production-runtime-gallery/assets/asset-inspector-webgl2.png",
  "app-material-studio": "tests/reports/production-runtime-gallery/materials/material-studio-webgl2.png",
  "app-character-viewer": "tests/reports/production-runtime-gallery/character/character-viewer-webgl2.png",
  "app-cinematic-postprocess": "tests/reports/production-runtime-gallery/postprocess/cinematic-before-webgl2.png",
  "app-large-scene-lab": "tests/reports/production-runtime-gallery/large-scene/large-scene-webgl2.png",
  "app-webgpu-lab": "tests/reports/production-runtime-gallery/product/product-configurator-webgpu.png",
  "app-threejs-parity-lab": "tests/reports/production-runtime-gallery/assets/boom-box-webgl2.png"
};
...
const checks = [
  ...
  { id: "manifest-schema", pass: manifest.schema === "a3d-production-runtime-gallery-manifest", detail: manifest.schema },
...
const generatedManifest = {
  schema: "a3d-production-runtime-generated-gallery-manifest",
...
const report = {
  schema: "a3d-production-runtime-gallery-readiness",
  generatedAt: new Date().toISOString(),
  pass: checks.every((check) => check.pass),
  entryCount: entries.length,
  categoryCounts,
  generatedManifest: "tests/reports/production-runtime-gallery/manifest.json",
  checks,
  entries
};
...
function sourceForEntry(entry: GalleryEntry): { readonly sourceAppPath: string; readonly sourceTestPath: string } {
  const appId = entry.id.startsWith("app-") ? entry.id.replace(/^app-/, "production-runtime-") : "";
  const testByCategory: Record<string, string> = {
    webgl2: "tests/browser/production-runtime-webgl2-real-renderer.spec.ts",
    "pbr-hdr": "tests/browser/production-runtime-pbr-hdr-real-renderer.spec.ts",
    gltf: "tests/browser/production-runtime-gltf-render-pipeline.spec.ts",
    effects: "tests/browser/production-runtime-effects-real-renderer.spec.ts",
    "animation-controls": "tests/browser/production-runtime-animation-controls-real-renderer.spec.ts",
    "app-suite": `tests/browser/production-runtime-${appId.replace(/^production-runtime-/, "")}.spec.ts`
  };
  return {
