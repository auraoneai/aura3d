...
const requiredScreenshots: readonly RequiredScreenshot[] = [
  ...
  { id: "product-visual-parity-galileo", path: "tests/reports/external-parity-product-visual-parity/galileo-product.png", source: "standalone", minImageColorBuckets: 24, minMeanLuma: 80, maxDarkPixelRatio: 0.2, maxDominantBucketRatio: 0.62, minEdgePixelRatio: 0.025, maxFlatPixelRatio: 0.72, minLocalContrastRatio: 0.09 },
