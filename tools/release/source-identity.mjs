...
export const isSourceInput = path => !!path
  ...
  // markers above. Editing an execution log while a producer is in flight
  // otherwise changes product source identity mid-run.
  ...
  // Scratch fixtures written by the deletion-safety calibration suite: created and
  // removed inside a single test run, so hashing them made source identity change
  // while a producer was executing its own named suite.
