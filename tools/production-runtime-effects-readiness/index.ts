...
const browserReportPath = resolve("tests/reports/production-runtime-effects-real-renderer.json");
const screenshotPath = resolve("tests/reports/production-runtime-effects/damaged-helmet-effects.png");
const reportPath = resolve("tests/reports/production-runtime-effects-readiness.json");
...
const report = {
  schema: "g3d-production-runtime-effects-readiness/v1",
