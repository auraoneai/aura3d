...
const manifestPath = resolve("tests/reports/v3-renderer-foundation/manifest.json");
...
const report = {
  schema: "g3d-v3-renderer-readiness/v1",
  ...
  sourceFiles,
  manifestPath: "tests/reports/v3-renderer-foundation/manifest.json",
...
writeFileSync(resolve("tests/reports/v3-renderer-readiness.json"), `${JSON.stringify(report, null, 2)}\n`);
