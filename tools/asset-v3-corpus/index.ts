...
const report = {
  ...
  command: "pnpm exec tsx --tsconfig tsconfig.base.json tools/asset-v3-corpus/index.ts",
  blockedClaims: [
  ...
  sourceFileHashes: [
    hashSource("tools/asset-v3-corpus/index.ts"),
...
function generatedSource(): CorpusFixture["source"] {
  return { kind: "generated", generator: "tools/asset-v3-corpus/index.ts", license: "CC0-1.0" };
}
