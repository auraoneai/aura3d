...
const reportPath = resolve("tests/reports/v6-animation-controls-readiness.json");
const browserReportPath = resolve("tests/reports/v6-animation-controls-real-renderer.json");
...
const report = {
  schema: "g3d-v6-animation-controls-readiness/v1",
