...
const requiredFiles = [
  ...
  "tools/v4-claim-registry/index.ts",
...
const report = {
  schema: "g3d-v4-docs-readiness/v1",
...
mkdirSync(dirname(resolve("tests/reports/v4-docs-readiness.json")), { recursive: true });
writeFileSync(resolve("tests/reports/v4-docs-readiness.json"), `${JSON.stringify(report, null, 2)}\n`);
if (!pass) {
