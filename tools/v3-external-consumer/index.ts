...
const packageSmokePath = resolve("tests/reports/v3-package-smoke.json");
...
const screenshotPath = resolve("tests/reports/v3-external-consumer/external-consumer.png");
const reportPath = resolve("tests/reports/v3-external-consumer.json");
...
const report = {
  schema: "g3d-v3-external-consumer/v1",
