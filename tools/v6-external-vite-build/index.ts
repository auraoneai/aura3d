...
const packDir = resolve("tests/reports/v6-external-vite-pack");
const previewDir = resolve("tests/reports/v6-external-consumer-preview");
const reportPath = resolve("tests/reports/v6-external-vite-build.json");
...
const tempRoot = mkdtempSync(join(tmpdir(), "g3d-v6-external-consumer-"));
...
try {
  ...
  const report = {
    schema: "g3d-v6-external-vite-build/v1",
