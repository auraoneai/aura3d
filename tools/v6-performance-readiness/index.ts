...
const baseline = json("tests/reports/v6-performance-baselines.json");
const browser = json("tests/reports/v6-large-scene-performance.json");
...
const screenshot = "tests/reports/v6-performance/large-scene-performance.png";
const checks = [
...
const report = {
  schema: "g3d-v6-performance-readiness/v1",
...
const reportPath = resolve("tests/reports/v6-performance-readiness.json");
