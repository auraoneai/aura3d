...
const reportPath = "tests/reports/external-parity-hdr-visual-parity.json";
const artifactDir = "tests/reports/external-parity-hdr-visual-parity";
const sourceFiles = [
    ...
    try {
      ...
      return {
        ...baseReport(root, {
          ...
          command: "pnpm audit:external-parity-hdr-visual-parity",
          runIdPrefix: "external-parity-hdr-visual-parity",
          sourceFiles,
          screenshotPaths,
          violations,
          blockedClaims: [
