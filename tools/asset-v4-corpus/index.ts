...
const reportPath = resolve("tests/reports/v4-asset-corpus.json");
...
const report = {
  ...
  command: "pnpm exec tsx --tsconfig tsconfig.base.json tools/asset-v4-corpus/index.ts",
  ...
  sourceFileHashes: [
    hashSource("tools/asset-v4-corpus/index.ts"),
...
function createArchitectureFixture(): V4Fixture {
  ...
  return {
    ...
    fileName: "v4-gallery-corner.gltf",
...
function generatedSource(): V4Fixture["source"] {
  return { kind: "generated-local", generator: "tools/asset-v4-corpus/index.ts" };
}
