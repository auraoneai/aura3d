...
const CAPABILITIES = [
  ...
  { id: "vehicle dynamics", symbols: ["ArcadeVehicleDynamicsSample", "PacejkaTireForceSample"], testSymbols: ["createVehicleChassis", "vehicleChassisSpecFromBounds"], agentApiSymbols: ["createVehicleChassis"] },
