...
const ROWS = [
  ...
  { category: "core-rendering", capability: "cameras", expected: "PerspectiveCamera / OrthographicCamera", symbols: ["camera"], integrated: true, claim: "parity", evidence: ["tests/reports/showcase-interaction-audit"] },
  ...
  { category: "physics", capability: "vehicle dynamics", expected: "Rapier vehicle controller, hand-tuned", symbols: ["createVehicleChassis", "vehicleChassisSpecFromBounds"], integrated: true, claim: "exceed", notes: "Chassis derives geometry from the asset's rendered bounds and resolves contact, suspension and attitude; grounding is asserted per frame rather than inferred.", evidence: ["tests/reports/turbo-vehicle-grounding"] },
  { category: "physics", capability: "vehicle AI driving", expected: "no standard solution; hand-written per project", symbols: ["createVehicleDriverAi"], integrated: true, claim: "exceed", notes: "Look-ahead racing line, curvature-based corner speeds, stuck and off-track recovery, deterministic per seed.", evidence: ["tests/reports/turbo-vehicle-grounding"] },
  ...
  { category: "game-systems", capability: "platformer motion tuning", expected: "hand-tuned gravity and jump velocity", symbols: ["solvePlatformerMotion", "validatePlatformerMotion"], integrated: true, claim: "exceed", notes: "Derives motion from level geometry and rejects tuning inconsistent with it. Skyline shipped a 5.76x apex overshoot that every prior gate passed.", evidence: ["tests/reports/skyline-platformer-motion"] },
