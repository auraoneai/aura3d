...
const preview = resolve("tests/reports/v5-external-consumer/static-preview/index.html");
...
const report = {
  schema: "g3d-v5-static-preview-smoke/v1",
  generatedAt: new Date().toISOString(),
  pass: existsSync(preview),
  previewPath: "tests/reports/v5-external-consumer/static-preview/index.html"
};
const reportPath = resolve("tests/reports/v5-static-preview-smoke.json");
