...
const allowedClaims = [
  {
    ...
    evidence: ["tests/reports/v6-webgl2-readiness.json", "tests/reports/v6-gallery-readiness.json"]
  },
  {
    id: "same-scene-threejs-evidence",
    claim: "V6 has same-scene Three.js comparison evidence for the required V6 corpus scenes.",
    evidence: ["tests/reports/v6-threejs-parity-readiness.json"]
  },
  {
  ...
  },
  {
    ...
    evidence: ["tests/reports/v6-performance-readiness.json"]
  }
];
const blockedClaims = [
...
const report = {
  schema: "g3d-v6-claim-registry/v1",
...
const reportPath = resolve("tests/reports/v6-claim-registry.json");
