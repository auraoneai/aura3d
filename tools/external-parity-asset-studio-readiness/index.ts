...
const expectedScreenshots = [
  ...
  "tests/reports/external-gallery/assets/external-asset-gallery-cesium-man.png",
  "tests/reports/external-gallery/assets/asset-studio-pro.png"
];
check("browser-report", browser?.ok === true && statePasses(example, "external-asset-gallery") && statePasses(selected, "external-asset-gallery") && statePasses(app, "asset-studio-pro") && isObj(selected.selectedAsset) && selected.selectedAsset.id === "cesium-man", "Browser report must prove example, selection, and app diagnostics UI.");
...
const report = { schema: "g3d-external-parity-asset-studio-readiness/v1", generatedAt: new Date().toISOString(), pass, summary: pass ? "V4 Milestone 10 Asset Studio Pro proof is ready as a corpus browser and diagnostics product milestone. Rendered asset parity remains required." : "V4 Milestone 10 Asset Studio Pro proof is incomplete.", checkedFiles: requiredFiles, checks };
