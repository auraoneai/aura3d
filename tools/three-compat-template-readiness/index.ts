...
const missing = templates.flatMap((template) => [`templates/${template}/index.html`, `templates/${template}/src/main.ts`, `templates/${template}/asset-manifest.json`, `packages/create-aura3d/templates/${template}/index.html`, `tests/reports/three-compat-templates/${template}.png`].filter((file) => !existsSync(resolve(file))));
