...
const required = ["apps/interactive-showcase-pro/index.html", "apps/interactive-showcase-pro/src/main.ts", "examples/external-interactive-showcase/index.html", "examples/external-interactive-showcase/main.ts", "examples/external-interactive-showcase/InteractiveShowcaseV4.ts", "tests/browser/external-parity-interactive-showcase.spec.ts", "tests/reports/external-parity-interactive-showcase-browser.json"] as const;
...
const source = text("examples/external-interactive-showcase/InteractiveShowcaseV4.ts");
...
const output = { schema: "g3d-external-parity-interactive-readiness/v1", generatedAt: new Date().toISOString(), pass, summary: pass ? "V4 Milestone 12 interactive showcase product surface is ready. Production 3D/Three.js parity remains required." : "V4 Milestone 12 is incomplete.", checkedFiles: required, checks };
