...
describe("V5 loader corpus", () => {
  it("loads real local GLB, OBJ/MTL, HDR, KTX2, and browser texture samples with diagnostics", () => {
    ...
    const compatGltf = new GLTFLoaderCompat().load("fixtures/v5/assets/corpus/boom-box.glb");
    const compatObj = new OBJLoaderCompat().load("fixtures/v5/loaders/sample.obj");
    const compatTexture = new ThreeCompatTextureLoader().load("tests/reports/v4-hdr-visual-parity/galileo-hdr.png");
