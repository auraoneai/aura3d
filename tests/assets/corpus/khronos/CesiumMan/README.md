...
This directory contains `CesiumMan.glb`, a pinned local copy of the externally authored Khronos glTF Sample Assets model:

- Repository: `https://github.com/KhronosGroup/glTF-Sample-Assets`
- Revision: `2bac6f8c57bf471df0d2a1e8a8ec023c7801dddf`
- Source path: `Models/CesiumMan/glTF-Binary/CesiumMan.glb`
