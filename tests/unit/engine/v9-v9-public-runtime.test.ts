...
import { G3DAppLifecycle, G3DRenderer, G3DScene, Geometry, PBRMaterial } from "@galileo3d/engine/v9";
import { MockRenderDevice } from "@galileo3d/rendering";
import { RendererV9 } from "@galileo3d/engine/rendering/v9";
import { GLTFLoader, createRenderableScene } from "@galileo3d/engine/assets/v9";
...
describe("V9 v9 public runtime", () => {
  ...
  it("renders a scene graph through @galileo3d/engine/v9 without hand-built RenderItem arrays", async () => {
