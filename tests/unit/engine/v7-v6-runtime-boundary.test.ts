...
describe("V7 V6 runtime boundary", () => {
  it("keeps the product renderer, app, template, and V6 examples independent from Three.js runtime delegation", () => {
    ...
    const report = {
      schema: "g3d-v7-v6-runtime-boundary/v1",
      ...
      caveat: "This enforces the V6 product/runtime boundary. Three.js remains allowed only in comparison, migration, and reference harnesses outside these roots."
    };
    const reportPath = resolve("tests/reports/v7/v6-runtime-boundary.json");
