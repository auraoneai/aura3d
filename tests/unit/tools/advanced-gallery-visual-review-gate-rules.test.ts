...
import { acceptedMetadataBlockers, acceptedRuntimeEvidenceBlockers } from "../../../tools/advanced-gallery-visual-review/gateRules";
...
describe("V9 advanced gallery visual review gate rules", () => {
  ...
  it("requires accepted metadata to include reviewer, current screenshot hash, timestamp, comparison basis, and known-gap acknowledgement", () => {
    ...
    expect(blockers).toContain("Accepted review screenshot must live under the contextual advanced-gallery report directory or its legacy compatibility alias and be a PNG.");
