...
import { V5_THREE_IMPORT_MAP, migrateThreeToG3D } from "../../../packages/three-compat/src";
...
`;
    ...
    expect(V5_THREE_IMPORT_MAP.three).toBe("@galileo3d/three-compat");
    expect(result.rewrittenImports).toBeGreaterThanOrEqual(4);
    expect(result.code).toContain("@galileo3d/three-compat");
    expect(result.code).toContain("@galileo3d/three-compat/controls");
    expect(result.code).toContain("@galileo3d/three-compat/loaders");
    expect(result.code).toContain("@galileo3d/three-compat/postprocessing");
