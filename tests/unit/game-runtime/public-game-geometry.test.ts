...
function createRacingPresentationFixture() {
  ...
  const topology = {
    ...
    modelAlignment: {
      ...
      evidence: { routeOverlay: "tests/reports/showcase-route-primary-probes/showcase-public-racing-presentation-proof.png", notes: "Fixture topology." }
    },
    evidence: {
      ...
      routeOverlay: "tests/reports/showcase-route-primary-probes/showcase-public-racing-presentation-proof.png",
...
function createPlatformerPresentationFixture() {
  ...
  const playableSurfaceMap = {
    ...
    modelAlignment: {
      ...
      evidence: { routeOverlay: "tests/reports/showcase-route-primary-probes/showcase-public-platformer-presentation-proof.png", notes: "Fixture platformer surface map." }
    },
    evidence: {
      ...
      routeOverlay: "tests/reports/showcase-route-primary-probes/showcase-public-platformer-presentation-proof.png",
