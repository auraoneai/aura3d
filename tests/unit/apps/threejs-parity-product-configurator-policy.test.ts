...
} from "../../../apps/advanced-examples-gallery/src/authoredLayer";
import {
...
describe("v9 product configurator policy", () => {
  ...
  it("pins the active product route to original texture-backed product GLBs", () => {
    ...
    expect(getAuthoredAssetCandidate("car-concept").localUrl).toBe("/fixtures/threejs-parity/assets/vehicles/car-concept.glb");
