...
const REPORT_PATH = "tests/reports/v9/loader-material-extensions-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/loader-material-extensions-parity/g3d-loader-material-extensions.png",
  threejs: "tests/reports/v9/loader-material-extensions-parity/threejs-loader-material-extensions.png",
  sideBySide: "tests/reports/v9/loader-material-extensions-parity/side-by-side.png"
} as const;
...
test.describe("V9 loader material extensions same-scene Three.js parity", () => {
  ...
  test("loads KHR_materials_sheen and KHR_materials_transmission through G3D and actual Three.js GLTFLoader", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-loader-material-extensions-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-loader-material-extensions-parity/v1");
...
type LoaderMaterialExtensionsParityResult =
  | {
      ...
      readonly schema: "g3d-v9-loader-material-extensions-parity/v1";
      readonly g3d: {
  ...
  | { readonly status: "error"; readonly schema: "g3d-v9-loader-material-extensions-parity/v1"; readonly error: string };
