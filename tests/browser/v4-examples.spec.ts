...
const reportPath = "tests/reports/v4-examples-browser.json";
const screenshotPath = "tests/reports/v4-gallery/gallery/v4-gallery.png";
...
test.describe("V4 examples and gallery", () => {
  ...
  test("loads the V4 gallery with real screenshots and example links", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/examples/v4-gallery/index.html`, { waitUntil: "domcontentloaded" });
    ...
    mkdirSync(join(process.cwd(), "tests/reports/v4-gallery/gallery"), { recursive: true });
