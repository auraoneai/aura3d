...
const REPORT_PATH = "tests/reports/v9/skinning-additive-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/skinning-additive-parity/g3d-skinning-additive.png",
  threejs: "tests/reports/v9/skinning-additive-parity/threejs-skinning-additive.png",
  sideBySide: "tests/reports/v9/skinning-additive-parity/side-by-side.png"
} as const;
...
test.describe("V9 skinning additive same-asset Three.js parity", () => {
  ...
  test("applies Robot Expressive upper-body additive Wave over Walking through G3D and actual Three.js", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-skinning-additive-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-skinning-additive-parity/v1");
...
function assertNoThreeJsInG3DSkinningAdditiveRuntimeSource(): void {
  ...
  for (const sourcePath of [
    "apps/v8-skinning-additive/src/main.ts",
    "apps/v8-skinning-additive/src/additiveLayers.ts",
...
type SkinningAdditiveParityResult =
  ...
  | { readonly status: "error"; readonly schema: "g3d-v9-skinning-additive-parity/v1"; readonly error: string };
