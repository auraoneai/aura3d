...
const reportPath = "tests/reports/v4-material-matrix-browser.json";
...
test.describe("V4 physical material matrix browser evidence", () => {
  ...
  test("proves visible material variation and public material diagnostics", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-gallery/materials/material-matrix.png";
    mkdirSync(join(process.cwd(), "tests/reports/v4-gallery/materials"), { recursive: true });
