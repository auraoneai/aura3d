...
const REPORT_PATH = "tests/reports/v9/physical-lights-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/physical-lights-parity/g3d-physical-lights.png",
  threejs: "tests/reports/v9/physical-lights-parity/threejs-physical-lights.png",
  sideBySide: "tests/reports/v9/physical-lights-parity/side-by-side.png"
} as const;
...
test.describe("V9 physical lights same-scene parity", () => {
  ...
  test("captures G3D point/spot attenuation against actual Three.js PointLight and SpotLight", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-physical-lights-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-physical-lights-parity/v1");
...
function assertNoThreeJsInG3DLightRuntimeSource(): void {
  ...
  for (const sourcePath of [
    "apps/v8-lights-spotlight/src/main.ts",
...
type PhysicalLightsParityResult =
  | {
      ...
      readonly schema: "g3d-v9-physical-lights-parity/v1";
      readonly g3d: {
