...
const reportPath = "tests/reports/v4-material-studio-pro-browser.json";
const screenshotDir = "tests/reports/v4-gallery/materials";
...
test.describe("V4 Material Studio Pro", () => {
  ...
  test("renders a product-grade physical material matrix in the example and app", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/examples/material-studio-v4/index.html`, { waitUntil: "domcontentloaded" });
    const exampleState = await waitForMaterialState(page, "material-studio-v4");
    await page.locator("[data-testid='hr4-material-canvas']").screenshot({ path: `${screenshotDir}/material-studio-v4.png` });
    ...
    await page.locator("[data-testid='hr4-material-canvas']").screenshot({ path: `${screenshotDir}/material-studio-v4-outdoor.png` });
    ...
    const report = {
      ok: errors.length === 0 &&
        statePasses(exampleState, "material-studio-v4") &&
        statePasses(outdoorState, "material-studio-v4") &&
        statePasses(appState, "material-studio-pro") &&
        outdoorState.environmentPreset === "outdoorDay",
      generatedAt: new Date().toISOString(),
      screenshots: [
        `${screenshotDir}/material-studio-v4.png`,
        `${screenshotDir}/material-studio-v4-outdoor.png`,
    ...
    expect(statePasses(exampleState, "material-studio-v4")).toBe(true);
    expect(statePasses(outdoorState, "material-studio-v4")).toBe(true);
