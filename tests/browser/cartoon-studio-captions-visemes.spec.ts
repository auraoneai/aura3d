...
test.describe("Aura3D Cartoon Studio captions and visemes", () => {
  ...
  test("exposes caption timing and mouth cue proof through the browser route", async ({ page }) => {
    ...
    const proof = await page.evaluate(() => {
      ...
      const seek = (window as unknown as { __AURA3D_CARTOON_EPISODE_SEEK__?: (time: number) => void }).__AURA3D_CARTOON_EPISODE_SEEK__;
