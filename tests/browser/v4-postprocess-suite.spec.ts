...
const reportPath = "tests/reports/v4-postprocess-suite-browser.json";
...
test.describe("V4 postprocess suite browser evidence", () => {
  ...
  test("proves postprocess lab output plus V4 bloom/SSAO/DOF/color-grade APIs", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-gallery/postprocess/postprocess-suite.png";
    mkdirSync(join(process.cwd(), "tests/reports/v4-gallery/postprocess"), { recursive: true });
