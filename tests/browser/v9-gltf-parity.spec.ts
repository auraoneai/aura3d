...
const REPORT_PATH = "tests/reports/v9/gltf-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/gltf-parity/g3d-gltf.png",
  threejs: "tests/reports/v9/gltf-parity/threejs-gltf.png",
  sideBySide: "tests/reports/v9/gltf-parity/side-by-side.png"
} as const;
...
test.describe("V9 GLTF same-asset Three.js parity", () => {
  ...
  test("loads Damaged Helmet through G3D and actual Three.js GLTFLoader", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-gltf-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-gltf-parity/v1");
...
function stripDataUrls(result: Extract<GltfParityResult, { readonly status: "ready" }>): Omit<typeof result, "dataUrls"> {
...
type GltfParityResult =
  | {
      ...
      readonly schema: "g3d-v9-gltf-parity/v1";
