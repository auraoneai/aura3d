...
const reportPath = resolve(process.cwd(), "tests/reports/v4-runtime.json");
const screenshotPath = resolve(process.cwd(), "tests/reports/v4-example-screenshots/game-slice-runtime.png");
...
const report: V4RuntimeReport = {
  ...
  screenshots: ["tests/reports/v4-example-screenshots/game-slice-runtime.png"],
  completedTasks: [
    {
      task: "Add runtime scene orchestration used by the V4 game slice.",
      evidence: ["examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add character controller integration with physics, camera, animation, and input.",
      evidence: ["packages/physics/src/CharacterController.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add deterministic AI navigation pathfinding and agent-steering evidence to the V4 game slice.",
      evidence: ["packages/physics/src/Navigation.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add deterministic arrive/steering behavior evidence to the V4 game slice.",
      evidence: ["packages/physics/src/Steering.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
    ...
    },
    {
      ...
      evidence: ["packages/physics/src/Crowd.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add deterministic AI perception and memory evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/Perception.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add behavior-tree blackboard runtime decision evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/BehaviorTree.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add decision-tree branch/action selection evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/DecisionTree.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add utility-AI action scoring and selected-decision evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/UtilityAI.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add finite-state-machine AI lifecycle and transition evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/StateMachine.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add GOAP objective planning evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/GOAP.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Add hierarchical-task-network objective decomposition evidence to the V4 game slice.",
      evidence: ["packages/scripting/src/HTN.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old adaptive difficulty and balancing concepts into current runtime evidence.",
      evidence: ["packages/scripting/src/AdaptiveDifficultyFixtures.ts", "examples/game-slice/main.ts", "tests/unit/scripting/weapon-system.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      ...
      evidence: ["packages/scripting/src/NetworkReplicationFixtures.ts", "examples/game-slice/main.ts", "tests/unit/scripting/weapon-system.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old cloth simulation, collision, tearing, and material concepts into current runtime evidence.",
      evidence: ["packages/physics/src/ClothFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      ...
      evidence: ["packages/physics/src/SoftBodyFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old Voronoi and hierarchical fracture concepts into current runtime evidence.",
      evidence: ["packages/physics/src/FractureFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old SPH, MPM, particle-buffer, and fluid-renderer concepts into current runtime evidence.",
      evidence: ["packages/physics/src/FluidFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      ...
      evidence: ["packages/physics/src/FireSmokeFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
    ...
    },
    {
      ...
      evidence: ["packages/audio/src/SceneAudioBridge.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old compressor, EQ, and spectrum-analysis audio concepts into current runtime evidence.",
      evidence: ["packages/audio/src/AudioEffectsAnalysisFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream5-input-audio-scripting-editor.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
    ...
    },
    {
      ...
      evidence: ["examples/asset-viewer/main.ts", "apps/editor/src/viewport/EditorViewport.ts", "examples/game-slice/main.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old input recording/playback concepts into current runtime input evidence.",
      evidence: ["packages/input/src/InputReplay.ts", "examples/game-slice/main.ts", "tests/unit/workstream5-input-audio-scripting-editor.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old input action binding processor and interaction concepts into current runtime evidence.",
      evidence: ["packages/input/src/InputActionBindingFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream5-input-audio-scripting-editor.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old gesture detection and rumble-pattern concepts into current runtime input evidence.",
      evidence: ["packages/input/src/GestureHapticsFixtures.ts", "examples/game-slice/main.ts", "tests/unit/input/gesture-haptics-fixtures.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old motion-matching trajectory/database concepts into current runtime animation evidence.",
      evidence: ["packages/animation/src/MotionMatchingFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream4.physics-animation.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old virtual touch joystick concepts into current runtime input evidence.",
      evidence: ["packages/input/src/VirtualTouchControls.ts", "examples/game-slice/main.ts", "tests/unit/workstream5-input-audio-scripting-editor.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    },
    {
      task: "Port bounded old XR session, input, and gaze-LOD concepts into current runtime evidence.",
      evidence: ["packages/input/src/XRFixtures.ts", "examples/game-slice/main.ts", "tests/unit/workstream5-input-audio-scripting-editor.test.ts", "tests/browser/runtime-v4.spec.ts", "tests/reports/v4-runtime.json"]
    }
  ],
  blockedTasks: [
