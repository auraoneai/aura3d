...
test.describe("V7 material extension parity artifact", () => {
  ...
  test("captures same-extension G3D vs Three.js material deltas", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tests/browser/v7-material-extension-parity.html`, { waitUntil: "domcontentloaded" });
    try {
    ...
    const reportDir = "tests/reports/v7/material-extension-parity";
