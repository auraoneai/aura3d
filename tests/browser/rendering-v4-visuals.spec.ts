...
test.describe("V4 renderer visual quality evidence", () => {
  ...
  const report: V4RenderingReport = {
    ...
    command: "pnpm exec playwright test tests/browser/rendering-v4-visuals.spec.ts",
    screenshots: [],
    validations: [],
    blockedClaims: [
  ...
  test.afterAll(async () => {
    ...
    const reportPath = resolve("tests/reports/v4-rendering.json");
  ...
  test("material showroom publishes V4 preset evidence and PBR/environment screenshot", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/material-showroom.png";
    ...
    const checks = {
      ...
      preset: state?.featureEvidence?.presetId === "galileo3d-v4-visual-quality-preset",
  ...
  test("PBR extension texture variants render through sampler-budgeted WebGL2 shaders", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/pbr-extension-texture-variants.png";
  ...
  test("shadow lab publishes V4 preset evidence and visible shadow screenshot", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/shadow-lab.png";
  ...
  test("shadow lab remains stable after resize and under DPR 2", async ({ browser }) => {
    ...
    try {
      await page.goto(`${server.origin}/examples/shadow-lab/index.html`, { waitUntil: "domcontentloaded" });
      await waitForState(page, "__GALILEO3D_SHADOW_LAB__");
      const dprScreenshot = "tests/reports/v4-example-screenshots/shadow-lab-dpr2.png";
      ...
      await waitForState(page, "__GALILEO3D_SHADOW_LAB__");
      const resizedScreenshot = "tests/reports/v4-example-screenshots/shadow-lab-resized-dpr2.png";
  ...
  test("forward pass samples a bound shadow map texture in real WebGL2 rendering", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/forward-shadow-map-check.png";
  ...
  test("postprocess lab publishes V4 preset evidence and before-after screenshot", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/postprocess-lab.png";
  ...
  test("postprocess lab exposes runtime color-management controls backed by real-scene pixels", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/postprocess-lab-color-controls.png";
    await captureScreenshot(page, "[data-testid='postprocess-lab-canvas']", screenshotPath);
  ...
  test("postprocess lab exposes color-grading controls backed by real-scene pixels", async ({ page }) => {
    ...
    const changed = await page.evaluate(() => window.__GALILEO3D_POSTPROCESS_LAB__);
    const screenshotPath = "tests/reports/v4-example-screenshots/postprocess-lab-color-grading.png";
    await captureScreenshot(page, "[data-testid='postprocess-lab-canvas']", screenshotPath);
    const checks = {
  ...
  test("renderer runtime toggles keep layout stable and change visual state", async ({ page }) => {
    ...
    const postprocessToggleScreenshot = "tests/reports/v4-example-screenshots/postprocess-lab-toggle-bloom-off.png";
    ...
    const shadowToggleScreenshot = "tests/reports/v4-example-screenshots/shadow-lab-toggle-darkness.png";
  ...
  test("webgpu capability example publishes supported and blocked visual evidence", async ({ page }) => {
    ...
    const screenshotPath = "tests/reports/v4-example-screenshots/webgpu-capability.png";
