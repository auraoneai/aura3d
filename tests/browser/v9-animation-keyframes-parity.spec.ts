...
const REPORT_PATH = "tests/reports/v9/animation-keyframes-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/animation-keyframes-parity/g3d-animation-keyframes.png",
  threejs: "tests/reports/v9/animation-keyframes-parity/threejs-animation-keyframes.png",
  sideBySide: "tests/reports/v9/animation-keyframes-parity/side-by-side.png"
} as const;
...
test.describe("V9 animation keyframes same-asset Three.js parity", () => {
  ...
  test("samples Robot Expressive keyframes through G3D and actual Three.js AnimationMixer", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-animation-keyframes-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-animation-keyframes-parity/v1");
...
function assertNoThreeJsInG3DAnimationKeyframesRuntimeSource(): void {
  ...
  for (const sourcePath of [
    "apps/v8-animation-keyframes/src/main.ts",
    "apps/v8-animation-keyframes/src/scene.ts",
