...
const REPORT_PATH = "tests/reports/v8-threejs-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v8/flagship/g3d-flagship-viewer.png",
  threejs: "tests/reports/v8/flagship/threejs-flagship-viewer.png",
  sideBySide: "tests/reports/v8/flagship/side-by-side.png"
} as const;
...
test.describe("V8 same-scene Three.js parity artifact", () => {
  ...
  test("captures honest G3D and actual Three.js flagship viewer deltas", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v8-threejs-parity/index.html`, { waitUntil: "domcontentloaded" });
    try {
    ...
    expect(result.schema).toBe("g3d-v8-threejs-parity/v1");
...
function assertNoThreeJsInG3DRuntimeSource(): void {
  const sourcePath = "benchmarks/galileo/src/scenes/v8-flagship-viewer.ts";
