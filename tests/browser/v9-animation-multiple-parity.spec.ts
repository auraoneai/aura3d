...
const REPORT_PATH = "tests/reports/v9/animation-multiple-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/animation-multiple-parity/g3d-animation-multiple.png",
  threejs: "tests/reports/v9/animation-multiple-parity/threejs-animation-multiple.png",
  sideBySide: "tests/reports/v9/animation-multiple-parity/side-by-side.png"
} as const;
...
test.describe("V9 animation multiple same-asset Three.js parity", () => {
  ...
  test("samples Soldier clones through G3D and actual Three.js AnimationMixer", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-animation-multiple-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-animation-multiple-parity/v1");
...
function assertNoThreeJsInG3DAnimationMultipleRuntimeSource(): void {
  ...
  for (const sourcePath of [
    "apps/v8-animation-multiple/src/main.ts",
    "apps/v8-animation-multiple/src/agentSpawner.ts",
...
type AnimationMultipleParityResult =
  | {
      ...
      readonly schema: "g3d-v9-animation-multiple-parity/v1";
