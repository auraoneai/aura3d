...
const reportPath = "tests/reports/v4-large-scene-browser.json";
const screenshotPath = "tests/reports/v4-gallery/performance/large-scene-performance.png";
...
test("V4 large scene captures object count, draw calls, frame budget, and screenshot proof", async ({ page }) => {
  ...
  mkdirSync(join(process.cwd(), "tests/reports/v4-gallery/performance"), { recursive: true });
