...
import { DEMOS as DEMO_DEFINITIONS } from "../../apps/v9-advanced-examples-gallery/src/metadata";
import { configuredAuthoredAssetIdsForDemo, expectedAuthoredAssetCountForDemo } from "../../apps/v9-advanced-examples-gallery/src/authoredLayer";
  ...
  for (const demo of DEMO_IDS) {
    test(`${demo} renders as a complex animated G3D demo`, async () => {
      ...
      try {
        ...
        await page.goto(`${server.origin}/apps/v9-advanced-examples-gallery/#${demo}`, { waitUntil: "domcontentloaded" });
