...
const REPORT_PATH = "tests/reports/v9/parallax-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/parallax-parity/g3d-parallax.png",
  threejs: "tests/reports/v9/parallax-parity/threejs-parallax.png",
  sideBySide: "tests/reports/v9/parallax-parity/side-by-side.png"
} as const;
...
test.describe("V9 parallax barrier same-scene Three.js parity", () => {
  ...
  test("captures G3D row-interleaved parallax against actual Three.js ParallaxBarrierEffect", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-parallax-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-parallax-parity/v1");
