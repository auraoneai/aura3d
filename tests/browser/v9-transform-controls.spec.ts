...
const SCREENSHOT_PATH = "tests/reports/v9/transform-controls/transform-controls.png";
...
test.describe("V9 TransformControls route evidence", () => {
  ...
  test("public TransformControls route applies translate, rotate, and scale to rendered geometry", async ({ page }) => {
    ...
    const response = await page.goto(`${server.origin}/apps/v8-controls-transform/`, { waitUntil: "domcontentloaded" });
