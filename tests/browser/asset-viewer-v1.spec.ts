...
test.describe("asset viewer v1", () => {
  ...
  test("renders the loaded asset as the dominant viewport subject", async ({ page }) => {
    await page.goto(`${server.origin}/examples/asset-viewer-v1/index.html`, { waitUntil: "domcontentloaded" });
    ...
    const screenshot = "tests/reports/asset-viewer-v1/asset-viewer.png";
    mkdirSync(dirname(screenshot), { recursive: true });
    await page.locator("[data-testid='asset-viewer-v1-canvas']").screenshot({ path: screenshot });
