...
const REPORT_PATH = "tests/reports/v9/skinning-ik-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/skinning-ik-parity/g3d-skinning-ik.png",
  threejs: "tests/reports/v9/skinning-ik-parity/threejs-skinning-ik.png",
  sideBySide: "tests/reports/v9/skinning-ik-parity/side-by-side.png"
} as const;
...
test.describe("V9 skinning IK same-asset Three.js parity", () => {
  ...
  test("solves Robot Expressive right-arm IK through G3D and a Three.js loaded-bone reference", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-skinning-ik-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-skinning-ik-parity/v1");
...
function assertNoThreeJsInG3DSkinningIkRuntimeSource(): void {
  ...
  for (const sourcePath of [
    "apps/v8-skinning-ik/src/main.ts",
    "apps/v8-skinning-ik/src/ikTargets.ts",
...
type SkinningIkParityResult =
  | {
      ...
      readonly schema: "g3d-v9-skinning-ik-parity/v1";
      readonly g3d: {
  ...
  | { readonly status: "error"; readonly schema: "g3d-v9-skinning-ik-parity/v1"; readonly error: string };
