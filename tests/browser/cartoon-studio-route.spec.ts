...
test.describe("Aura3D Cartoon Studio route proof", () => {
  ...
  test("boots the cartoon-studio route and exposes episode proof", async ({ page }) => {
    ...
    expect(proof.template).toBe("cartoon-studio");
