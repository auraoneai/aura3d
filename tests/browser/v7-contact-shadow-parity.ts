...
import { createContactShadowPass } from "/packages/rendering/src/v6/index.js";
...
async function run(): Promise<void> {
  ...
  window.__V7_CONTACT_SHADOW_PARITY__ = {
    ...
    diff,
    artifacts: {
      g3d: "tests/reports/v7/contact-shadow-parity/g3d-contact-shadow.png",
      threejs: "tests/reports/v7/contact-shadow-parity/threejs-contact-shadow.png",
      diff: "tests/reports/v7/contact-shadow-parity/contact-shadow-diff.png"
    },
    dataUrls: {
