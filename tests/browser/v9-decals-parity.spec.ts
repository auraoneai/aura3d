...
const REPORT_PATH = "tests/reports/v9/decals-parity.json";
const ARTIFACTS = {
  g3d: "tests/reports/v9/decals-parity/g3d-decals.png",
  threejs: "tests/reports/v9/decals-parity/threejs-decals.png",
  sideBySide: "tests/reports/v9/decals-parity/side-by-side.png"
} as const;
...
test.describe("V9 decals same-scene Three.js parity", () => {
  ...
  test("captures G3D projected decals against actual Three.js DecalGeometry", async ({ page }) => {
    ...
    await page.goto(`${server.origin}/tools/v9-decals-parity/index.html`, { waitUntil: "domcontentloaded" });
    ...
    expect(result.schema).toBe("g3d-v9-decals-parity/v1");
...
type DecalsParityResult =
  | {
      ...
      readonly schema: "g3d-v9-decals-parity/v1";
