...
```bash
G3D_DISABLE_SYSTEM_WEBGPU_BROWSER=true pnpm exec playwright test tests/browser/v9-advanced-examples-gallery.spec.ts -g "<demo-id> renders as a complex animated G3D demo" --reporter=line --timeout=240000
pnpm v9:advanced-gallery:review
```
...
7. `pnpm v9:advanced-gallery:review` accepts the route.
