import { createStudioLighting } from "@galileo3d/engine/v6";
...
export type ProductConfiguratorShowroomLightingPreset = "v6-product-studio" | "v6-inspection-studio";
...
export function createProductConfiguratorShowroomLighting(
  ...
  return {
    preset: inspection ? "v6-inspection-studio" : "v6-product-studio",
