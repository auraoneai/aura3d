...
export const AUTHORED_ASSET_CANDIDATES = [
  {
    ...
    localUrl: "/fixtures/v9/assets/water-cinematic-marina-blender/water-cinematic-marina-blender.glb",
    routeUse: "water-lab",
    ...
    knownLimitations: [
      ...
      "The interactive wave/ripple system remains G3D CPU/procedural geometry because a native GPGPU water solver is not exposed."
    ],
    acceptanceFocus: [
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/marina-lake-scene/marina-lake-scene.gltf",
    routeUse: "water-lab",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/marina-lake-blender/marina-lake-blender.glb",
    routeUse: "water-lab",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "showcase environment",
    animated: false,
    knownLimitations: [
      ...
      "The water route still uses G3D CPU/procedural ripple geometry because a native GPGPU water solver is not exposed."
    ],
    acceptanceFocus: [
  ...
  },
  {
    ...
    localUrl: "/fixtures/assets/v4/environment/v4-game-outpost/v4-game-outpost.gltf",
    routeUse: "water-lab",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/assets/v3/architecture/civic-gallery-room/civic-gallery-room.gltf",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/ocean-observatory-cinematic-blender/ocean-observatory-cinematic-blender.glb",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/ocean-observatory-deck/ocean-observatory-deck.gltf",
    routeUse: "ocean-observatory",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v3/assets/material-spheres/material-spheres.glb",
    routeUse: "reactor-post",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v3/assets/product-camera/product-camera.glb",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v3/assets/variant-product/variant-product.glb",
    routeUse: "product-configurator",
  ...
  },
  {
    id: "toy-car",
    title: "Toy Car",
    localUrl: "/fixtures/v7/assets/flagship/toy-car.glb",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/materials/compare-sheen.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF material extension proof",
    visualRole: "material proof prop",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/product/damaged-helmet.glb",
    routeUse: "reactor-post",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/materials/compare-clearcoat.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF material extension proof",
    visualRole: "material proof prop",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/materials/compare-transmission.glb",
    routeUse: "ocean-observatory",
    threeReferenceCategory: "glTF material extension proof",
    visualRole: "material proof prop",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/glass-broken-window.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF material extension proof",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/glass-vase-flowers.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF material extension proof",
    visualRole: "transparent product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/glam-velvet-sofa.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "hero product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/digital-twin-factory-blender/digital-twin-factory-blender.glb",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/commercial-refrigerator.glb",
    routeUse: "digital-twin",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "hero product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/reactor-command-center-blender/reactor-command-center-blender.glb",
    routeUse: "reactor-post",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/product-configurator-studio-blender/product-configurator-studio-blender.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    id: "car-concept",
    title: "Car Concept",
    localUrl: "/fixtures/v8/assets/vehicles/car-concept.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "hero product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/product-configurator-car-batched/car-concept-batched.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "hero product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/product/chronograph-watch.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "hero product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/product/materials-variants-shoe.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF material variants",
    visualRole: "material variant product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/product/sunglasses-khronos.glb",
    routeUse: "product-configurator",
    threeReferenceCategory: "glTF product / PBR material asset",
    visualRole: "transparent product",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/sponza-packed/sponza-packed.glb",
    routeUse: "fog-cathedral",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
    knownLimitations: [
      "This is an official Khronos glTF Sample Assets environment packed locally into a single GLB; it is not generated by G3D.",
      "It improves authored architectural detail, but G3D still lacks a production volumetric raymarch/god-ray pass for this route.",
    ...
    acceptanceFocus: [
      ...
      "G3D loads external glTF buffers and many texture references without fallback-white materials.",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/khronos-showcase/sponza-cathedral-crop/sponza-cathedral-crop.glb",
    routeUse: "fog-cathedral",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
    knownLimitations: [
      "This is a curated local crop of the official Khronos Sponza asset with added G3D fog/light-shaft staging; it is not a native volumetric renderer.",
      "Texture payload and draw-call cost must stay visible in the route report before it can be considered for acceptance.",
      "The route still approximates god rays with transparent geometry cards because G3D does not expose a production volumetric raymarch pass."
    ],
    acceptanceFocus: [
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/fog-cathedral-blender/fog-cathedral-blender.glb",
    routeUse: "fog-cathedral",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "showcase environment",
    animated: false,
    knownLimitations: [
      ...
      "Light shafts and fog cards remain geometry/material approximations until G3D exposes a production volumetric pass."
    ],
    acceptanceFocus: [
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/architecture/antique-camera-interior.glb",
    routeUse: "fog-cathedral",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "interior environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/architecture/lantern-interior.glb",
    routeUse: "fog-cathedral",
    threeReferenceCategory: "glTF interior / environment",
    visualRole: "interior environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/character/robot-expressive.glb",
    ...
    knownLimitations: [
      ...
      "Morph targets and facial expression support must be verified in the active G3D importer."
    ],
    acceptanceFocus: [
  ...
  },
  {
    id: "soldier",
    title: "Soldier",
    localUrl: "/fixtures/v8/assets/character/soldier.glb",
    routeUse: "robotics-lab",
    threeReferenceCategory: "glTF animation / skinning",
    visualRole: "animated character",
    animated: true,
  ...
  },
  {
    id: "xbot",
    title: "XBot",
    localUrl: "/fixtures/v8/assets/character/xbot.glb",
    routeUse: "robotics-lab",
    threeReferenceCategory: "glTF animation / skinning",
    visualRole: "animated character",
    animated: true,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/physics-robotics-testbed-blender/physics-robotics-testbed-blender.glb",
    routeUse: "physics-playground",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/physics/cesium-milk-truck.glb",
    routeUse: "physics-playground",
    threeReferenceCategory: "glTF physics-scale prop",
    visualRole: "physics prop",
    animated: false,
  ...
  },
  {
    id: "duck",
    title: "Duck",
    localUrl: "/fixtures/v8/assets/physics/duck.glb",
    routeUse: "physics-playground",
    threeReferenceCategory: "glTF physics-scale prop",
    visualRole: "physics prop",
    animated: false,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/smart-city-district/smart-city-district.gltf",
    routeUse: "smart-city",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
    knownLimitations: [
      ...
      "It proves G3D can load and compose a dense batched city GLTF quickly, while route-level data pulses and traffic supply runtime motion."
    ],
    acceptanceFocus: [
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/showcase/littlest-tokyo.glb",
    routeUse: "smart-city",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: true,
    knownLimitations: [
      "This is an official-style authored animated showcase fixture, but it still needs G3D load-time, animation, material, and camera-bound verification before acceptance.",
    ...
    acceptanceFocus: [
      ...
      "The smart-city route frames the authored scene as the main subject while retaining G3D traffic/data overlays as supporting systems."
    ]
  },
  {
    id: "data-galaxy-core-blender",
    title: "Authored AI Data Galaxy Core",
    localUrl: "/fixtures/v9/assets/data-galaxy-core-blender/data-galaxy-core-blender.glb",
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/animation/animated-morph-cube.glb",
    routeUse: "data-galaxy",
    threeReferenceCategory: "glTF animation / skinning",
    visualRole: "environment prop",
    animated: true,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/animation/animated-colors-cube.glb",
    routeUse: "data-galaxy",
    threeReferenceCategory: "glTF animation / skinning",
    visualRole: "environment prop",
    animated: true,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v8/assets/animation/box-animated.glb",
    routeUse: "data-galaxy",
    threeReferenceCategory: "glTF animation / skinning",
    visualRole: "environment prop",
    animated: true,
  ...
  },
  {
    ...
    localUrl: "/fixtures/v9/assets/robotics-training-lab-blender/robotics-training-lab-blender.glb",
    routeUse: "robotics-lab",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
  ...
  },
  {
    id: "kira-ik-room",
    title: "Kira IK Room",
    localUrl: "/fixtures/v8/assets/showcase/kira-ik-room.glb",
    routeUse: "robotics-lab",
    threeReferenceCategory: "glTF showcase scene",
    visualRole: "showcase environment",
    animated: false,
