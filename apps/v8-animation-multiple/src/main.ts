...
const APP_ID = "v8-animation-multiple" as const;
const ASSET_URL = "/fixtures/v8/assets/character/soldier.glb";
...
async function run(): Promise<void> {
  ...
  try {
    ...
    const pipeline = await loadV6GLTFRenderPipeline({
      url: ASSET_URL,
      assetId: "v8-animation-multiple-soldier-crowd",
      ...
      try {
        ...
        const result = renderer.renderFrame({
          ...
          metadata: {
            ...
            assetUri: "/apps/v8-animation-multiple/",
