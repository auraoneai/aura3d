...
interface V8LoaderCompressionRuntime {
  readonly appId: "v8-loader-compression";
...
const APP_ID = "v8-loader-compression" as const;
const WIDTH = 1280;
const HEIGHT = 720;
...
function createRendererInput(resources: GLTFRenderResources, time: number): Parameters<G3DRenderer["renderFrame"]>[0] {
  ...
  return {
    ...
    metadata: {
      ...
      assetUri: "/apps/v8-loader-compression/",
      meshCount: 1,
      primitiveCount: 1,
      materialCount: 1,
      textureCount: 0,
...
function createMeshoptFixtureDataUrl(): string {
  ...
  const gltf = {
    ...
    materials: [{
      name: "v8-loader-compression-material",
      pbrMetallicRoughness: { baseColorFactor: [0.96, 0.48, 0.16, 1], roughnessFactor: 0.48, metallicFactor: 0.08 },
      extensions: { KHR_materials_unlit: {} }
    }],
    meshes: [{
      name: "v8-loader-compression-triangle",
      primitives: [{ attributes: { POSITION: 0, NORMAL: 1 }, indices: 2, material: 0 }]
    }],
    nodes: [{ name: "v8-loader-compression-node", mesh: 0 }],
    scenes: [{ name: "v8-loader-compression-scene", nodes: [0] }],
    scene: 0
  };
...
function createDracoFixtureDataUrl(): string {
  ...
  const gltf = {
    ...
    nodes: [{ name: "v8-loader-compression-draco-node", mesh: 0 }],
    scenes: [{ name: "v8-loader-compression-draco-scene", nodes: [0] }],
    scene: 0
  };
  return `data:model/gltf+json;base64,${base64(new TextEncoder().encode(JSON.stringify(gltf)))}`;
}
