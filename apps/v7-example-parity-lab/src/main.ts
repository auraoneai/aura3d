...
import { createAnimationController, createPhysicsScene } from "@galileo3d/engine/v6";
import {
  Geometry,
  PBRMaterial,
...
interface V7ExampleParityRuntime {
  ...
  readonly appId: "v7-example-parity-lab";
...
const APP_ID = "v7-example-parity-lab" as const;
const WIDTH = 2560;
const HEIGHT = 1440;
...
async function run(): Promise<void> {
  ...
  try {
    ...
    const [robot, soldier, morph, helmet, watch, car, shoe] = await Promise.all([
      ...
      loadPipeline("/fixtures/v6/assets/corpus/animated-morph-cube.glb", "animated-morph-cube"),
      loadPipeline("/fixtures/v6/assets/corpus/damaged-helmet.glb", "damaged-helmet"),
    ...
    const metadata = {
      ...
      assetUri: "/apps/v7-example-parity-lab/",
