...
interface V8ShadowmapViewerRuntime {
  readonly appId: "v8-shadowmap-viewer";
...
const APP_ID = "v8-shadowmap-viewer" as const;
const WIDTH = 1280;
const HEIGHT = 720;
...
async function run(): Promise<void> {
  ...
  try {
    ...
    const light = new DirectionalLight("v8-shadowmap-viewer-light");
    ...
    const shadowMap = new ShadowMap({
      ...
      pcfRadius: 1.5,
      pcfSamples: 9,
      label: "v8-shadowmap-viewer-depth"
    });
