...
import { type StereoControlState } from "../../v8-stereo-effects/src/stereoControls.js";
...
interface V8ParallaxBarrierRuntime {
  readonly appId: "v8-parallax-barrier";
...
const APP_ID = "v8-parallax-barrier" as const;
