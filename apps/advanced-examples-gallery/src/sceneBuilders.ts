...
export function createResources(): Resources {
  const material: Record<string, Material | PBRMaterial | UnlitMaterial | InstancedPBRMaterial> = {
    ...
    cityC: hologramInstanced("cityC", "#2eb89a", [0.04, 0.48, 0.36], 0.42, 0.2),
	    traffic: instanced("traffic", "#f3c04a", 0.12, 0.34, [1, 0.42, 0.04], 1.6),
	    logistics: instanced("logistics", "#ff7d3b", 0.16, 0.3, [1, 0.18, 0.025], 1.8),
	    sensor: instanced("sensor", "#2bd9ff", 0.05, 0.22, [0.02, 0.8, 1], 2.3),
