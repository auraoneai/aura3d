...
export const PRODUCT_CONFIGURATOR_SCENEBUILDER_PATCH_POINTS = [
  "apps/advanced-examples-gallery/src/sceneBuilders.ts: replace the product-configurator switch branch with an import from a product-specific scene module.",
  "apps/advanced-examples-gallery/src/sceneBuilders.ts: move buildProduct, productBodyMaterial, and productAccentMaterial into that product-specific module.",
  "apps/advanced-examples-gallery/src/main.ts: keep visibleProceduralItems(product-configurator) limited to reusable studio floor/backdrop/calibration helpers while the authored GLB is ready."
] as const;
