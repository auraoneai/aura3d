...
export const DEMOS: readonly DemoDefinition[] = [
  ...
  },
  {
    ...
    reference: "Reference target: Three.js particle and galaxy composition demos. Current state: G3D point-buffer visualization with animated transforms and explicit compute-solver limits.",
    ...
    proves: ["G3D can support animated data visualization evidence with explicit CPU/static point-buffer tradeoff reporting and a route-owned focal composition."],
  ...
  },
  {
    ...
    reference: "Reference target: Three.js glTF product configurators. Current state: accepted texture-backed single-car G3D product route with imported car material variants, reusable studio staging, and explicit interaction/rendering boundaries.",
    ...
    proves: ["G3D can load and stage the original texture-backed car-concept GLB with imported material-variant controls, turntable motion, route-side exploded offsets, reusable indoor-studio staging, material diagnostics, and performance instrumentation inside an accepted smooth product-render scope."],
  ...
  },
  {
    ...
    proves: ["G3D can support accepted atmospheric composition controls with explicitly bounded volumetric approximations."],
