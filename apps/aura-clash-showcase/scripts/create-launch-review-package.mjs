...
const evidencePaths = {
  ...
  readiness: resolve(appRoot, "tests/reports/flagship-readiness.json"),
  screenshotMeta: resolve(appRoot, "launch-evidence/first-frame.json"),
  screenshotPng: resolve(appRoot, "launch-evidence/aura-clash-arena-first-frame.png"),
  combatScreenshotPng: resolve(appRoot, "launch-evidence/aura-clash-arena-combat-frame.png"),
  koResetScreenshotPng: resolve(appRoot, "launch-evidence/aura-clash-arena-ko-frame.png"),
...
const summary = [
  ...
  ["2.0 flagship readiness evidence", gateStatus(evidence.readiness?.ok === true)],
  ["First-frame screenshot metadata", evidence.screenshotMeta ? gateStatus(evidence.screenshotMeta?.ok === true) : "MISSING"],
