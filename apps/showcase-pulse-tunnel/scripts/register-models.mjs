...
const definitions = [
  ["pulseReactorEncounterWorld", "assets/models/pulseReactorEncounterWorld.glb", "world", "Original continuous gameplay-scale reactor world with connected deck, containment walls, ribs, roof depth, terminal bay, and visible fire/impact anchors. Its deliberately untextured stylized flat-color PBR material separation is the finished route art direction, not missing texture evidence; the world is decorative and non-colliding while route-local lanes, gates, projectiles, and collisions remain authoritative."],
