import { G3DAppLifecycle, G3DRenderer, G3DScene, Geometry, PBRMaterial, UnlitMaterial } from "@galileo3d/engine/v9";
...
lifecycle.addEventListener(window, "g3d:v9-public-scene-dispose", () => {
  lifecycle.dispose();
  publishDisposedRuntime();
});
