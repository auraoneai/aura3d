type PortfolioExample = {
  ...
  readonly tier: "Visual Blocked" | "Combined Proof" | "Renderer Proof" | "Runtime Proof" | "Editor Proof" | "Asset Proof";
...
const examples: PortfolioExample[] = [
  ...
  },
  {
    ...
    proof: "The page loads, publishes renderer metrics, and the current screenshot passes the automated V4 screenshot-health gate.",
  ...
  },
  {
    ...
    proof: "The page loads, publishes room/material/measurement metrics, and has a regression test for visible orbit/zone camera changes.",
  ...
  },
  {
    ...
    proof: "Runtime controls, objective metrics, and the current screenshot-health gate pass for this generated game slice.",
  ...
  },
  {
    ...
    proof: "The browser test verifies telemetry, seeded texture evidence, screenshot-health metrics, HUD pixels, and nonblank WebGL pixels.",
...
const localReadinessDemos: readonly LocalReadinessDemo[] = [
  {
    ...
    caveat: "Blocked by current visual quality: the live product scene is too primitive to count as rendered product visual proof.",
  },
  {
    id: "pbr",
    ...
    caveat: "Blocked by current visual quality: the material showroom does not yet demonstrate high-definition or materially convincing PBR output.",
  },
  {
    ...
    caveat: "Blocked by current presentation quality: this is still a technical diagnostic page, not a convincing HDR render-target demo.",
  },
  {
    id: "shadow-map",
    ...
    caveat: "Blocked by current visual quality: the shadow lab is diagnostic and not production-quality shadow-map proof.",
  },
  {
    ...
    caveat: "Blocked by current visual quality: this is still a lab layout, not a polished full-frame postprocess-suite demo.",
  },
  {
    id: "gltf",
...
function renderCard(example: PortfolioExample): string {
  ...
  const tierClass = example.tier === "Visual Blocked" ? "tier tier-visual-blocked" : "tier";
  return `
