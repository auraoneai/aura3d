...
import { isRecord, readJson } from "../v4-reporting/index.js";
...
export interface V4LocalPortStatusSummary {
  ...
  readonly evidencePaths: {
    ...
    readonly completionAudit: "tests/reports/v4-completion-audit.json";
    readonly externalEvidence: "tests/reports/v4-external-evidence-readiness.json";
    readonly completionRunbook: "tests/reports/v4-completion-audit-runbook.md";
    readonly externalEvidenceRunbook: "tests/reports/v4-external-evidence-missing-artifacts.md";
  };
  readonly commands: {
...
export function createV4LocalPortStatusSummary(root = process.cwd()): V4LocalPortStatusSummary {
  const docsV3 = scanMarkdownUnchecked(root, "docs/v3");
  const docsV4 = scanMarkdownUnchecked(root, "docs/v4");
  const oldCodebasePortPlan = scanMarkdownUnchecked(root, "docs/project/v4-old-codebase-port-plan.md");
  const completion = readJson(root, "tests/reports/v4-completion-audit.json");
...
function scanMarkdownUnchecked(root: string, relativePath: string): MarkdownUncheckedSummary {
