...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@aura3d/engine/rendering/v6": new URL("./packages/rendering/src/production-runtime/index.ts", import.meta.url).pathname,
      "@aura3d/engine/rendering/v9": new URL("./packages/rendering/src/advanced-runtime/index.ts", import.meta.url).pathname,
      ...
      "@aura3d/engine/assets/v6": new URL("./packages/assets/src/asset-corpus/index.ts", import.meta.url).pathname,
      "@aura3d/engine/assets/v9": new URL("./packages/assets/src/advanced-gallery/index.ts", import.meta.url).pathname,
      ...
      "@aura3d/engine/v6": new URL("./packages/engine/src/production-runtime/index.ts", import.meta.url).pathname,
      "@aura3d/engine/v9": new URL("./packages/engine/src/advanced-runtime/index.ts", import.meta.url).pathname,
      ...
      "@aura3d/engine/workflows/v6": new URL("./packages/workflows/src/production-runtime/index.ts", import.meta.url).pathname,
