...
declare global {
  interface Window {
    __A3D_EXTERNAL_PARITY_INTERIOR_SCENE__?: unknown;
  }
}
...
const claimBoundary = "Milestone 9 interior scene proof only; ExternalParity release still requires same-scene Three.js visual parity, real scanned material assets, and final package/template proof.";

export async function mountExternalInteriorScene(id: string): Promise<void> {
  ...
  function render(): void {
    ...
    window.__A3D_EXTERNAL_PARITY_INTERIOR_SCENE__ = state;
