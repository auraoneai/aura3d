...
export const V4_THREEJS_PARITY_SCENES: readonly V4ThreeJsParityScene[] = [
  {
    ...
    a3dWorkflow: "product-configurator",
    threeScene: "product-gltf",
    visualIntent: ["same BoomBox GLB", "front three-quarter camera", "studio lighting", "PBR material response"],
    a3dSetupLines: 15,
    threeSetupLines: 74,
    requiredGaps: ["Three.js scene uses manual GLTFLoader/camera/light setup; A3D uses a product workflow preset."]
  },
  {
    id: "asset-review",
    title: "glTF Asset Review",
    a3dWorkflow: "asset-viewer",
