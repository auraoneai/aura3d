...
|---|---:|---:|---:|---:|
| `@aura3d/engine agent API excluding lazy Three.js renderer chunk` | 47,571 | 16,107 | 80,000 | pass |
...
| `product-viewer starter app before user assets` | 766,564 | 204,353 | 250,000 | pass |
| `cinematic-scene starter app before user assets` | 766,692 | 204,427 | 250,000 | pass |
| `mini-game starter app before user assets` | 766,697 | 204,430 | 250,000 | pass |
