...
|---|---:|---:|---:|---:|
| `@aura3d/engine agent API excluding lazy Three.js renderer chunk` | 51,404 | 17,029 | 80,000 | pass |
...
| `product-viewer starter app before user assets` | 770,443 | 205,346 | 250,000 | pass |
| `cinematic-scene starter app before user assets` | 770,571 | 205,419 | 250,000 | pass |
| `mini-game starter app before user assets` | 770,576 | 205,422 | 250,000 | pass |
