...
|---|---:|---:|---:|---:|
| `@aura3d/engine agent API excluding lazy Three.js renderer chunk` | 45,977 | 15,480 | 80,000 | pass |
...
| `product-viewer starter app before user assets` | 764,970 | 203,709 | 250,000 | pass |
| `cinematic-scene starter app before user assets` | 765,098 | 203,783 | 250,000 | pass |
| `mini-game starter app before user assets` | 765,103 | 203,786 | 250,000 | pass |
